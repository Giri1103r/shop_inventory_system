        ...
        <tr>
            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                ...
                <p style="font-family: sans-serif; font-size: 14px; margin: 0; margin-bottom: 15px;">
                    We are pleased to inform you that you have been assigned as the trainer for the upcoming training
                    session. Below are the details of the scheduled training:
                ...
                <p style="font-family: sans-serif; font-size: 14px; margin: 20px 0 0 0;">
                    Please prepare accordingly and ensure that the training session runs smoothly and effectively. </p>

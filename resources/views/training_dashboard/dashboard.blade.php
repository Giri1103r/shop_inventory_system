...
@section('header', 'Training Dashboard')
                        ...
                        <div class="card-body px-0 pt-0 dlab-scroll height370">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="javascript:void(0);">
                                            <h5 class="fs-14 font-w600 mb-0">Total Training</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h5 class="fs-14 font-w600 mb-0 status-count" id="total_training">0</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center market-preview"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="javascript:void(0);">
                                            <h5 class="fs-14 font-w600 mb-0">Training Pending</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                        <h5 class="fs-14 font-w600 mb-0 status-count" id="training_pending">0</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center market-preview"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="javascript:void(0);">
                                            <h5 class="fs-14 font-w600 mb-0">Training Rejected</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                        <h5 class="fs-14 font-w600 mb-0 status-count" id="training_rejected">0</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center market-preview"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="javascript:void(0);">
                                            <h5 class="fs-14 font-w600 mb-0">Training in Progress</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                        <h5 class="fs-14 font-w600 mb-0 status-count" id="training_inprogress">0</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center market-preview"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="javascript:void(0);">
                                            <h5 class="fs-14 font-w600 mb-0">Training Completed</h5>
                                        </a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                        <h5 class="fs-14 font-w600 mb-0 status-count" id="training_completed">0</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        function getalldashmetric(Fromdate = '', Todate = '') {
            ...
            $('#total_training').html('0');
            $('#training_pending').html('0');
            $('#training_rejected').html('0');
            $('#training_inprogress').html('0');
            $('#training_completed').html('0');
            ...
            $.ajax({
                ...
                success: function(dataAjx) {
                    ...
                    var training_status = metric_data['trainingStatus'];
                    $('#total_training').html(training_status[0].count);
                    $('#training_pending').html(training_status[1].count);
                    $('#training_rejected').html(training_status[2].count);
                    $('#training_inprogress').html(training_status[3].count);
                    $('#training_completed').html(training_status[4].count);

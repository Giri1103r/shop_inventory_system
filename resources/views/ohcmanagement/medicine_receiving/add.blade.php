                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <select name="medicine_id" id="medicine_id"
                                                    class="form-control form-control-sm single-select" style="width: 100%">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <input type="text" name="hsn_display" id="hsn_id" class="form-control"
                                                    readonly>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <select name="vendor_id" id="vendor_id"
                                                    ...
                                                    @foreach ($vendor as $list)
                                                        <option value="{{ encryptId($list->id) }}">{{ $list->vendor_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>

                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="roadsidefirstaid"
                                        ...
                                        @csrf
                                         <input type="hidden" name="id" class="form-control" id="id" value="{{encryptId($opd_roadside_first_aid->id)}}">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-2 department">
                                                <div class="form-group form-input">
                                                    ...
                                                    <div class="input-group date form-input custom-height">
                                                        <input type="text" name="date_of_incident" id="date_of_incident" value="{{displaydateformat($opd_roadside_first_aid->date_of_incident)}}"
                                                            class="form-control">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <div class="input-group date form-input custom-height">
                                                        <input type="text" name="time_of_incident" id="time_of_incident" value="{{$opd_roadside_first_aid->time_of_incident}}"
                                                            class="form-control">
                                                        <div class="input-group-addon input-group-text">
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="person_condtion" id="person_condtion"
                                                        ...
                                                        @foreach ($injuredCondition as $list)
                                                            <option value="{{ $list->id }}" @if ($list->id == $opd_roadside_first_aid->person_condtion)selected
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="first_aider_name" id="first_aider_name"
                                                        ...
                                                        <option value="{{ $opd_roadside_first_aid->first_aider_name }}" selected>
                                                            {{ $opd_roadside_first_aid->first_aider_name }}</option>
                                                    @endif
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="transport_to_medical_facility" id="transport_to_medical_facility" class="form-select single-select" style="width:100%">
                                                        <option value="">Select the Option</option>
                                                        <option value="1" {{ isset($opd_roadside_first_aid) && $opd_roadside_first_aid->transport_to_medical_facility == 1 ? 'selected' : '' }}>
                                                            Yes
                                                        </option>
                                                        <option value="2" {{ isset($opd_roadside_first_aid) && $opd_roadside_first_aid->transport_to_medical_facility == 2 ? 'selected' : '' }}>
                                                            No
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-4 transport_method" style="display: none">
                                                <div class="form-group form-input">
                                                    <label for="follow" class="form-label require">Transport
                                                        Method</label>
                                                    <input type="text" name="transport_method" class="form-control" value="{{$opd_roadside_first_aid->transport_method}}
                                                        id="transport_method">
                                                </div>
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#transport_to_medical_facility').change(toggleDetailsField);
        });

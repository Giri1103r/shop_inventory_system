                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            <div class="form-group form-input">
                                                                ...
                                                                <input type="text" name ="amount_given_by[1]"
                                                                    class="form-control" placeholder="Amount Given By"
                                                                    value="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            <div class="form-group form-input">
                                                                ...
                                                                <input type="text" name ="amount_received_by[1]"
                                                                    class="form-control" placeholder="Amount Received By"
                                                                    value="">
                                                            </div>
                                                        </div>
...
@push('script')
    <script type="text/javascript" nonce="projectcab">
        $(document).ready(function() {
            ...
            // $(document).on('change', '[id^="unit_id"]', function() {
            //     var unitId = $(this).val();
            //     var departmentSelect = $(this).closest('.col-md-4').next('.col-md-4').find(
            //     '#department_id'); 

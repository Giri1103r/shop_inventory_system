...
@section('title', 'Medicine Stock Inventory Approval')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="align-back-btc">
                                    <x-button-back href="{{ admin_url('ohc/medicine-stock-inventory/list') }}"></x-button-back>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">
                                        <h4 class="text-white">Medicine Request Details</h4>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        ...
                                        <div class="view_data">
                                            {{ isset($medicine_stock->quantity) ? $medicine_stock->quantity : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        ...
                                        <div class="view_data">
                                            {{ getUsername(isset($medicine_stock->created_by) ? $medicine_stock->created_by : '') }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">{{ __('common.created_date') }}</label>
                                        <div class="view_data">
                                            {{ displayDateformat($medicine_stock->created_at) }}
                                        </div>
                                    </div>
...
{{-- Paramedicies Request  --}}
                                <div>
                                    <form method="POST" id="paramedicesForm"
                                        action="{{ admin_url('ohc/medicine-stock-inventory/requestapproval/submit') }}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ encryptId($medicine_stock->id) }}">
                                        <div class="row">
                                            <div class="card-header-inner">

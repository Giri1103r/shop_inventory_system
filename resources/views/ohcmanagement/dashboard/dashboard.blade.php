                                        ...
                                        <div class="media ai-icon" style="display: flex; align-items: center;">
                                            <span class="me-3 bgl-primary text-primary" style="flex-shrink: 0;">
                                                <svg width="50" height="50" viewBox="0 0 50 50" stroke="currentColor"
                                                    ...
                                                    <path d="M25.0018 32.1411H17.8594V35.7124H25.0018V32.1411Z"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M25.0018 39.2836H17.8594V42.8548H25.0018V39.2836Z"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M42.8583 32.1411H35.7158V35.7124H42.8583V32.1411Z"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M42.8583 39.2836H35.7158V42.8548H42.8583V39.2836Z"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path

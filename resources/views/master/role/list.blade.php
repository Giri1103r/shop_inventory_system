                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-3 mb-3 form-input">
                                                        <label for="inspectiontype" class="form-label ">Role</label>
    ...
    <script type="text/javascript" nonce="projectcab">
        ...
        $(function() {
            ...
            $(document).on('click', '.statusChange', function() {
                ...
                if (types == 1) {
                    var title = '{{ __('Do You want to In-Activate User Role') }}';
                    var text = '{{ __('common.inactive') }}';
                    var btncolor = '#dc3545'

                } else {
                    var title = '{{ __('Do You want to Activate User Role') }}';
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                var title = '{{ __('Do You want to Delete User Role') }}';
                            ...
                            error: function(data) {
                                if (data.status === 406 && data.responseJSON.msg ===
                                    ...
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Error',
                                        text: 'Role Deletion Failed: Module Dependencies Exist.',
                                    });
                                } else {
                                    $.notify(data.responseJSON.msg, "error");
                                }

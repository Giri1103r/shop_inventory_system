...
@section('title', 'Equipment Checklist Import')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-end p-2 gap-2">
                                    <x-button-download href="{{ admin_url('ptw/checklistmaster/sample_download') }}"></x-button-download>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="companyimport" enctype="multipart/form-data"
                                        action="{{ admin_url('ptw/checklistmaster/import/Submit') }}">
                                        @csrf
                                        <div class="row">

                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="card-header-inner">
                                        <h4 class="text-white">Venue Details</h4>
                                    </div>
                                </div>
                                <div class="row">

                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">Name of the Conference Hall</label>
                                        <div class="view_data">
                                            {{ isset($venue->name_of_the_conference_hall) ? $venue->name_of_the_conference_hall : '' }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">Unit Name</label>
                                        <div class="view_data">
                                            {{ isset($venue->unit_name) ? $venue->unit_name : '' }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">Capacity</label>
                                        <div class="view_data">
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        ...
                                        <div class="view_data">
                                            {{ getusername($venue->created_by) }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">{{ __('common.created_date') }}</label>
                                        <div class="view_data">
                                            {{ displayDateformat($venue->created_at) }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">

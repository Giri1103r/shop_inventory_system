                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        @if (CheckUserPermission('import'))
                            <x-button-import href="{{ admin_url('ptw/protectiveequipmentmaster/import') }}"></x-button-import>
                        @endif
                        @if (CheckUserPermission('add'))
                            <x-button-add dataId="" class="add btn btn-primary ms-1"
                                href="{{ admin_url('ptw/protectiveequipmentmaster/add') }}">Add</x-button-add>
                        @endif
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="protective_equip" class="form-label ">Work Name</label>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('ptw/protectiveequipmentmaster/list') }}",
                        type: 'POST',
                        headers: {
                        ...
                        data: function(d) {
                            d.protective_equip = $('#protective_equip').val();
                            d.status = $('#status').val();
                    ...
                    columns: [{
                        ...
                        {
                            data: 'protective_equip',
                            name: 'protective_equip'
                        },
                    ...
                    buttons: [{
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        protective_equip = $('#protective_equip').val();
                                        status = $('#status').val();

                                        $(".dt-button").removeClass('processing');
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('ptw/protectiveequipmentmaster/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('ptw/protectiveequipmentmaster/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&protective_equip=' + protective_equip +
                                            '&status=' + status
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('ptw/protectiveequipmentmaster/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('ptw/protectiveequipmentmaster/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

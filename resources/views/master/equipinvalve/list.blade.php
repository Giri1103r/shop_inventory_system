                ...
                <div class="card">
                    ...
                    <div class="ms-auto">
                        ...
                        @if (CheckUserPermission('import'))
                            <x-button-import href="{{ admin_url('ptw/equipinvolvemaster/import') }}"></x-button-import>
                        @endif
                        @if (CheckUserPermission('add'))
                            <x-button-add dataId="" class="add btn btn-primary"
                                href="{{ admin_url('ptw/equipinvolvemaster/add') }}">Add</x-button-add>
                        @endif
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="equip_involve" class="form-label ">Work Name</label>
                                            <input type="text" name="equip_involve" id="equip_involve"
                                                class="form-control">
                                        </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('ptw/equipinvolvemaster/list') }}",
                        type: 'POST',
                        headers: {
                        ...
                        data: function(d) {
                            d.equip_involve = $('#equip_involve').val();
                            d.status = $('#status').val();
                    ...
                    buttons: [{
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        equip_involve = $('#equip_involve').val();
                                        status = $('#status').val();

                                        $(".dt-button").removeClass('processing');
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('ptw/equipinvolvemaster/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('ptw/equipinvolvemaster/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&equip_involve=' + equip_involve +
                                            '&status=' + status
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('ptw/equipinvolvemaster/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('ptw/equipinvolvemaster/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

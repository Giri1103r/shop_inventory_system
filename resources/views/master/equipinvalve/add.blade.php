...
@section('title', 'Equipment Involved in Job Add')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="equip_involveadd" action="{{ admin_url('ptw/equipinvolvemaster/add/submit') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="equip_involve" class="form-control"
                                                        placeholder="Name">
                                                </div>
                                            </div>

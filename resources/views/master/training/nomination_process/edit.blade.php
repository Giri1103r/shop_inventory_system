                                ...
                                <div class="basic-form">
                                    <form method="POST" id="nomination_processedit"
                                        ...
                                        <input type="hidden" name="id" id="id"
                                            value="{{ encryptId($nomination_process->id) }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-input">
                                                        ...
                                                        <input type="text" name ="from_date" id="from_date_datepicker"
                                                            ...
                                                            value="{{ Displaydatetimeformat($nomination_process->from_date) }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-input">
                                                        ...
                                                        <input type="text" name ="to_date" id="to_date_datepicker"
                                                            ...
                                                            value="{{ Displaydatetimeformat($nomination_process->to_date) }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group form-input">
                                                        ...
                                                        <select name="venue_id" id="venue_id"
                                                            ...
                                                            @foreach ($venueList as $venue)
                                                                <option @if ($nomination_process->venue_id == $venue->id) selected @endif
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="topic_id" id="topic_id"
                                                        ...
                                                        @foreach ($topicList as $topic)
                                                            <option @if ($nomination_process->topic_id == $topic->id) selected @endif
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="trainer_id" id="trainer_id"
                                                        ...
                                                        @foreach ($employeeList as $employee)
                                                            <option @if ($nomination_process->trainer_id == $employee->id) selected @endif
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="unit_id" id="unit_id"
                                                        ...
                                                        @foreach ($unitList as $unit)
                                                            <option @if ($nomination_process->unit_id == $unit->id) selected @endif
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="department_id" id="department_id"
                                                        ...
                                                        @foreach ($departmentList as $department)
                                                            <option @if ($nomination_process->department_id == $department->id) selected @endif
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="target_trainees" id="target_trainees"
                                                        ...
                                                        value="{{ $nomination_process->target_trainees }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
...
@push('script')
    <script type="text/javascript" nonce="projectcab">
        $(document).ready(function() {
            ...
            var preselectedDepartmentId = "{{ encryptId($nomination_process->department_id) ?? '0' }}";
        ...
        $(document).ready(function() {
            ...
            $('#nomination_processedit').validate({
                rules: {
                    from_date: {
                        required: true,
                    },

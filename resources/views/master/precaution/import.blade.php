...
@section('title', 'Precaution to be taken Import')
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="companyimport" enctype="multipart/form-data"
                                        action="{{ admin_url('ptw/precautionmaster/import/submit') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 col-md-6 form-input">
                                                <label class="form-label required">File</label>
                                                <input type="file"  name="precaution_upload" class="form-control"  placeholder="">
                                            </div>
                                        </div>
                                        <hr>

                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-end p-2 gap-2">
                                    <x-button-download
                                        href="{{ admin_url('ppe_ppetype_master/sampledownload') }}"></x-button-download>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="ppeimport" enctype="multipart/form-data"
                                        action="{{ admin_url('ppe_ppetype_master/import/submit') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 col-md-6 form-input">
                                                <label class="form-label required">PPE Master File</label>
                                                <input type="file" name="ppe_upload" class="form-control"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        <hr>

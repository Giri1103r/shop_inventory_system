...
<script>
    ...
    var monthwisetraining = new ApexCharts(document.querySelector("#month_Ppe_request_Data"), options);
    monthwisetraining.render();

    // Download chart logic
    document.getElementById("month_wise_request").addEventListener("click", function() {

                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="accident_report_no" id="accident_report_no"
                                                        ...
                                                        value = "{{ $accident_report->accident_report_no }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="department_id" id="department_id"
                                                        ...
                                                        @foreach ($departmentList as $department)
                                                            <option @if ($accident_report->department_id == $department->id) selected @endif
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="shift" id="shift" class="form-control"
                                                        placeholder="Shift" value = "{{ $accident_report->shift }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group form-input">
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <textarea class="form-control" name="address_of_the_injuredperson" id="address_of_the_injuredperson">{{ $accident_report->address_of_the_injuredperson }}</textarea>
...
@push('script')
    <script type="text/javascript" nonce="projectcab">
        $(document).ready(function() {
            ...
            var preselectedDepartmentId = "{{ encryptId($accident_report->department_id) ?? '0' }}";

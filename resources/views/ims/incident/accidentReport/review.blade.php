                ...
                <div class="col-12">
                    <div class="col-12">
                        <div class="card">
                            ...
                            @if ($accident_report->incident_status == STATUS_ACCIDENT_REPORT)
                            <div class="card-body ">
                                    ...
                                    <form method="POST" id="ehs_head_review"
                                        ...
                                        <div class="row">
                                            <input type="hidden" class="form-control" name="incident_id"
                                                id="incident_id" value="{{ encryptId($accident_report->id) }}">
                        ...
                        @if ($accident_report->incident_status >= STATUS_EHSVERIFY_PENDING)
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">
                        ...
                        @if (
                            $accident_report->incident_status == STATUS_EHSVERIFY_PENDING ||
                                $accident_report->incident_status == STATUS_EHSAPPROVAL_REJECTED)
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">
                        ...
                        @if ($accident_report->incident_status == STATUS_ACTION_PENDING)
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">
                        ...
                        @elseif(
                            $accident_report->incident_status > STATUS_ACTION_PENDING &&
                                $accident_report->incident_status != STATUS_EHSAPPROVAL_REJECTED)
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">
                        ...
                        @endif
                        @if ($accident_report->incident_status == STATUS_EHSAPPROVAL_PENDING)
                            <div class="card-body ">
                                <div class="row">
                                    <div class="card-header-inner">

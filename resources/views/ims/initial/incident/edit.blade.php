                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" name="reporting_media[]"
                                                            ...
                                                            value="1" @if (in_array('1', $selectedMedia)) checked @endif>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" name="reporting_media[]"
                                                            ...
                                                            value="2" @if (in_array('2', $selectedMedia)) checked @endif>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="shift" id="shift"
                                                        class="form-control" value = "{{ $initialincident->shift }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group form-input">
                                                    ...
                                                    <textarea type="text" name="immediate_action_taken" id = "immediate_action_taken"
                                                        class="form-control immediate_action_taken" placeholder="">{{ $initialincident->immediate_action_taken }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input type="radio" name="anyone_injured" id="injured_yes"
                                                            ...
                                                            @if (isset($initialincident) && $initialincident->anyone_injured == 1) checked @endif>
                                                        <label class="form-check-label" for="injured_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" name="anyone_injured" id="injured_no"
                                                            class="form-check-input" value="0"
                                                            @if (isset($initialincident) && $initialincident->anyone_injured == 0) checked @endif>
                                                        ...
                                                        <div class="injury-details-templat">
                                                            <div class="row injury-append" style="margin-top: 20px;">
                                                                ...
                                                                {{-- <span id="injury_body_part_0-error"
                                                                    class="error invalid-feedback">This field is
                                                                    required.</span> --}}
...
@push('script')
    ...
    `;
            ...
            function addInjuryPersonValidation(injuryIndex) {
                ...
                $(`input[name="injury_person[${injuryIndex}][injury_person_name]"]`).rules("add", {
                    required: {
                        depends: function() {
                            let selectedType = $(
                                    `select[name="injury_person[${injuryIndex}][injury_person_type]"]`)
                                .val();
                            return (selectedType ==
                            "{{ encryptId('3') }}");
                        }
                    ...
                    messages: {
                        required: "Injury Person Name is required when Person Type is Others."
                    }
                });
        ...
        function clearInjuryBasicDetails() {
            ...
            $(modalsrc).find(':input[name="save_inj"]').prop('', false);

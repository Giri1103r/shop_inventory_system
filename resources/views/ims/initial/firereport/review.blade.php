                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="basic-form">
                                        <form method="POST" id="ehs_head_review"
                                            action="{{ admin_url('incident/fire-incident/ehs_head_review/submit') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" class="form-control" name="fire_inicdent_report_id"
                                                    id="fire_inicdent_report_id"
                            ...
                            @if ($incident_report->incident_status >= STATUS_EHSVERIFY_PENDING)
                                <div class="card-body ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-4 form-input">
                                            <label class="form-label view_label">What factors caused the Fire
                                                Incident?</label>
                                            <div class="view_data">
                                                @php
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="basic-form">
                                        <form method="POST" id="ehs_head_verify"
                                            action="{{ admin_url('incident/fire-incident/ehs_head_verify/submit') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" class="form-control" name="fire_inicdent_report_id"
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="basic-form">
                                        <form method="POST" id="action_submission"
                                            action="{{ admin_url('incident/fire-incident/actiontaken/submit') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" class="form-control" name="fire_inicdent_report_id"
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="basic-form">
                                        <form method="POST" id="ehs_approval"
                                            action="{{ admin_url('incident/fire-incident/ehApproval/submit') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" class="form-control" name="fire_inicdent_report_id"
    ...
    <script type="text/javascript" nonce="projectcab">
        $(document).ready(function() {
            ...
            $('#team_id').select2({
                ...
                closeOnSelect: true,
                ajax: {
                    url: "{{ admin_url('incident/fire-incident/teamMembers') }}",
                    type: "GET",
                    dataType: "json",
                    delay: 250,

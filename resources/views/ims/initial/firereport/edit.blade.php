...
@section('title', 'Initial Fire Incident Edit')
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="initialIncidentedit"
                                        action="{{ admin_url('incident/fire-incident/edit/submit') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="id" id="id"
                                            value="{{ encryptId($initialfireincident->id) }}">
                                            ...
                                            <div class="col-md-4 mb-2 ">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name ="sr_no" id="sr_no" class="form-control"
                                                        ...
                                                        value="{{ $initialfireincident->sr_no }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="incident_date_time" id="incident_date_time"
                                                        class="form-control"
                                                        value = "{{ $initialfireincident->incident_date_time }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="unit_id" id="unit_id"
                                                        ...
                                                        @foreach ($unitList as $unit)
                                                            <option value="{{ encryptId($unit->id) }}"
                                                                @if ($unit->id == $initialfireincident->unit_id) selected @endif>
                                                                {{ $unit->unit_name }}
                                                        @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="shift" id="shift" class="form-control"
                                                        value = "{{ $initialfireincident->shift }}">
                                                </div>
                                            </div>
                                                    ...
                                                    <select name="location_id" id="location_id"
                                                        ...
                                                        @foreach ($locationList as $location)
                                                            <option value="{{ encryptId($location->id) }}"
                                                                @if ($location->id == $initialfireincident->location_id) selected @endif>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="exact_location" id="exact_location"
                                                        ...
                                                        value = "{{ $initialfireincident->exact_location }}">
                                                </div>
                                            </div>
                                                    ...
                                                    @foreach ($incTypeList as $incType)
                                                        <div class="form-check">
                                                            <input type="radio" name="iir_type"
                                                                ...
                                                                value="{{ $incType->id }}"
                                                                @if (isset($initialfireincident) && $initialfireincident->iir_type == $incType->id) checked @endif>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="designation"
                                                        ...
                                                        value = "{{ $initialfireincident->designation }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <select name="department" class="form-control department">
                                                        ...
                                                        <option value="{{ $initialfireincident->department }}" selected>
                                                            {{ $initialfireincident->reported_department }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="employee_code"
                                                        ...
                                                        readonly value = "{{ $initialfireincident->employee_code }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="time_of_reporting"
                                                        ...
                                                        value = "{{ $initialfireincident->time_of_reporting }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    @php
                                                        $selectedMedia = isset($initialfireincident->reporting_media)
                                                            ? explode(',', $initialfireincident->reporting_media)
                                                            : [];
                                            ...
                                            <div class="col-md-4" id = "reporting_media_othersdiv" style="display: none">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="reporting_media_othersdesc"
                                                        ...
                                                        value = "{{ $initialfireincident->reporting_media_others }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group form-input">
                                                    ...
                                                    <textarea type="text" name="brief_description" id = "brief_description" class="form-control brief_description"
                                                        placeholder="">{{ $initialfireincident->brief_description }}</textarea>
                                                </div>
                                            </div>

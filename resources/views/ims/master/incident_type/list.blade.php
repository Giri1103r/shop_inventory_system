...
@section('pageurl', admin_url('incident/type-master/list'))
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <div class="form-group form-input">
                                                <label class="form-label ">Incident Type Name</label>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <div class="form-group form-input">
                                                <label class="form-label ">Incident Type Short Name</label>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                ajax: {
                    url: "{{ admin_url('incident/type-master/list') }}",
                    type: 'POST',
                    headers: {
                    ...
                    data: function(d) {
                        d.incident_type_id = $('#incident_type_id').val();
                        d.incident_type_name = $('#incident_type_name').val();
                ...
                buttons: [{
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    var incident_type_id = $('#incident_type_id').val();
                                    ...
                                    window.location.href =
                                        "{{ admin_url('incident/type-master/export/pdf') }}" +
                                        '?search=' + searchValue +
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    $('body').click();
                                    window.location.href =
                                        "{{ admin_url('incident/type-master/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&incident_type_id=' + incident_type_id +
                                        '&incident_type_name=' + incident_type_name +
                                        '&short_name=' + short_name +
            ...
            $(document).on('click', '.statusChange', function() {
                ...
                if (types == 1) {
                    var title = '{{ __('Do You want to In-Activate Incident Type') }}';
                    var text = '{{ __('common.inactive') }}';
                    var btncolor = '#dc3545'

                } else {
                    var title = '{{ __('Do You want to Activate Incident Type') }}';
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('incident/type-master/status') }}",
                            type: 'post',
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('incident/type-master/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')

            ...
            <div class="img-content col-lg-4 col-md-4 col-sm-4" data-type='img-full'>
                <div class="img-map">
                                            ...
                                            <script type="text/template" id="tmp-male">
                                                ...
                                                <area alt="" data-parentid = "0" data-isparent="0"  onclick="changeImage()" title="Right Chest" data-map="thirteen"  shape="poly" coords="46,108,44,115,43,125,43,135,72,135,71,108" />
                                                <area alt="" data-parentid = "0" data-isparent="0"  onclick="changeImage()" title="Left Chest" data-map="fourteen"  shape="poly" coords="72,107,102,109,101,135,72,137" />
                                                ...
                                                <area alt="" data-parentid = "0" data-isparent="0"  onclick="changeImage()" title="Right Ankle" data-map="twentyfive"  shape="poly" coords="56,326,67,326,67,343,55,341,58,334" />
                                                <area alt="" data-parentid = "0" data-isparent="0"  onclick="changeImage()" title="Left Ankle" data-map="twentysix"  shape="poly" coords="80,327,89,327,92,345,80,343,78,345" />
                    ...
                    <div class="img-map-parts">
                        ...
                        <div class="parts male-face">
                            ...
                            <map id='imgmap201293016112' data-map="head"
                                ...
                                <area alt="" title="Left Eyebrow" shape="poly" data-map="F"
                                    coords="102,243,248,242,250,206,127,207,89,207,90,214,97,217,103,225" />
                                <area alt="" title="Right Eyebrow" shape="poly" data-map="G"
                                    coords="386,243,250,242,250,206,410,206,406,218,398,233,390,243" />
                                <area alt="" id="test" title="Left Eye" shape="poly" data-map="H"
                                    coords="216,297,102,297,104,244,246,244" />
                                <area alt="" title="Right Eye" shape="poly" data-map="I"
                        ...
                        <div class="parts male-hand-right">
                            ...
                            <map id='imgmap201293016112' data-map="hand-right"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="Right Palm" data-map='hand-right-palm' shape="poly"
                        ...
                        <div class="parts male-hand-left">
                            ...
                            <map id='imgmap201293016112' data-map="hand-left"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="Left Palm" data-map='hand-left-palm' shape="poly"
                        ...
                        <div class="parts female-face">
                            ...
                            <map id='imgmap201293016112' data-map="head"
                                ...
                                <area alt="" title="Right Ear" data-map='O' shape="poly"
                                ...
                                <area alt="" title="Left Jaw" data-map='P' shape="poly"
                                    coords="320,452,252,450,254,427,347,430,334,441,327,450" />

                                <area alt="" title="Right Jaw" data-map='Q' shape="poly"
                                    coords="182,452,254,453,254,430,158,429,161,439,174,447,181,452" />

                                <area alt="" title="Chin" data-map='R' shape="poly"
                ...
                <div class="table-container">
                    <table class="table table-bordered injtable table-scroll"
                        ...
                        <thead>
                            ...
                            <?php
                            if (!empty($countBodyPart)) {
                                $i = 1;
                                $displayedParts = []; // Array to track unique body parts

                                foreach ($countBodyPart as $countpart) {
                                    $bodyPart = $countpart['body_part'];
                                    $trname = str_replace(' ', '', $bodyPart);

                                    // Skip if already displayed
                                    if (in_array($bodyPart, $displayedParts)) {
                                        continue;
                                    }

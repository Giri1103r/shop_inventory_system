...
@section('title', 'Manufacture Master Import')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-end p-2 gap-2">
                                    <x-button-download
                                        href="{{ admin_url('master/manufacture/sampledownload') }}"></x-button-download>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="companyimport" enctype="multipart/form-data"
                                        action="{{ admin_url('master/manufacture/import/submit') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 col-md-6 form-input">
                                                <label class="form-label require">{{ __('common.file') }}</label>

...
@section('title', 'Manufacture Master')
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 p-2">
                        ...
                        <x-button-add dataId="" class="add" href="{{ admin_url('master/manufacture/add') }}">
                            Add
                        </x-button-add>
                        ...
                        <x-button-import href="{{ admin_url('master/manufacture/import') }}">
                        </x-button-import>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                ajax: {
                    url: "{{ admin_url('master/manufacture/list') }}",
                    type: 'POST',
                    headers: {
                ...
                buttons: [{
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    var exportUrl =
                                        "{{ admin_url('master/manufacture/export/pdf') }}";
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    var formData = $('#formsearch').serialize();
                                    var exportUrl =
                                        "{{ admin_url('master/manufacture/export/excel') }}";
                                    window.location.href = exportUrl + '?search=' +
                                        searchValue + '&' +
                                        formData;
                                }
            ...
            $(document).on('click', '.statusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('master/manufacture/status') }}",
                            type: 'post',
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('master/manufacture/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="locationedit" action="{{ admin_url('master/location/edit/submit') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    <label class="form-label require">{{__('common.location_id')}}</label>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    <label class="form-label require">{{__('common.locaion')}}</label>
            ...
            $('#locationedit').validate({
                rules: {
                    ...
                    location_name: {
                        ...
                        remote: {
                            url: '{{ admin_url('master/location/unique') }}',
                            type: 'post',
                            data: {

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="add_page" action="{{ admin_url('master/tax/add/submit') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name ="tax_id" class="form-control"
                                                        placeholder="Enter the Tax Id" value="{{ getsequence('tax') }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-2">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="hsn_codes" id="hsn_codes"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="tax_percetage" id="tax_percetage"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="cgst_percentage" id="cgst_percentage"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="sgst_percentage" id="sgst_percentage"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="igst_percentage" id="igst_percentage"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="cess_percentage" id="cess_percentage"

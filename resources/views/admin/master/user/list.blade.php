...
@section('title', 'Users')
@section('pageurl', admin_url('administration/users/list'))
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        {{-- @if (CheckUserPermission('import'))
                            <x-button-import href="{{ admin_url('administration/users/import') }}"></x-button-import>
                        @endif
                        @if (CheckUserPermission('add'))
                            <x-button-add dataId="" class="add btn btn-primary ms-1"
                                href="{{ admin_url('administration/users/add') }}">Add</x-button-add>
                        @endif --}}
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="inspectiontype" class="form-label ">User ID</label>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('administration/users/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('administration/users/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('administration/users/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&employee_id=' + employee_id +
                                            '&name=' + name +
                                            '&status=' + status
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    if (types == 1) {
                        var title = '{{ __('Do You want to In-Activate Location Management') }}';
                        var text = '{{ __('common.inactive') }}';
                        var btncolor = '#dc3545'

                    } else {
                        var title = '{{ __('Do You want to Activate Location Management') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('administration/users/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    var title = '{{ __('Do You want to Delete Location Management') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('administration/users/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

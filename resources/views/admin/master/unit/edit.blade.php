                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="align-back-btc d-flex justify-content-end align-items-center">
                                    <x-button-back href="{{ admin_url('master/unit/list') }}"></x-button-back>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="unitedit" action="{{ admin_url('master/unit/edit/submit') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    <label class="form-label require">{{__('common.unit_id')}}</label>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group form-input">
                                                    <label class="form-label require">{{__('common.commpany')}}</label>
            ...
            $('#unitedit').validate({
                rules: {
                    ...
                    unit_name: {
                        ...
                        remote: {
                            url: '{{ admin_url('master/unit/unique') }}',
                            type: 'post',
                            data: {

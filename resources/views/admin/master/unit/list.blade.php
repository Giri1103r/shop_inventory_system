...
@section('pageurl', admin_url('master/unit/list'))
                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 p-2">
                        ...
                        @if (CheckUserPermission('export'))
                            <x-button-import href="{{ admin_url('master/unit/import') }}"></x-button-import>
                        @endif
                        @if (CheckUserPermission('add'))
                            <x-button-add dataId="" class="add btn btn-primary ms-1"
                                href="{{ admin_url('master/unit/add') }}">{{ __('common.add') }}</x-button-add>
                        @endif
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="unit_id" class="form-label ">{{ __('common.unit_id') }}</label>
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="unit_name" class="form-label ">{{ __('common.unit') }}</label>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('master/unit/list') }}",
                        type: 'POST',
                        headers: {
                    ...
                    buttons: [{
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        var exportUrl =
                                            "{{ admin_url('master/unit/export/pdf') }}";
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        var formData = $('#formsearch').serialize();
                                        var exportUrl =
                                            "{{ admin_url('master/unit/export/excel') }}";
                                        window.location.href = exportUrl + '?search=' +
                                            searchValue + '&' +
                                            formData;
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('master/unit/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('master/unit/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')
                                ...
                                error: function(data) {
                                    if (data.status === 406 && data.responseJSON.msg ===
                                        ...
                                        Swal.fire({
                                            icon: 'error',
                                            title: 'Error',
                                            text: 'Unit Deletion Failed: Module Dependencies Exist.',
                                        });
                                    } else {
                                        $.notify(data.responseJSON.msg, "error");
                                    }

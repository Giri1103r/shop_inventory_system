            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 p-2">
                        ...
                        <x-button-add dataId="" class="add" href="{{ admin_url('master/company/add') }}">
                            Add
                        </x-button-add>
                        ...
                        <x-button-import href="{{ admin_url('master/company/import') }}">
                        </x-button-import>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="company_id" class="form-label">{{ __('common.company_id') }}</label>
                                            <input type="text" name="company_id" id="company_id" class="form-control"
                                                placeholder="Company ID">
                                        </div>
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="company_name" class="form-label">{{ __('common.company') }}</label>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>{{ __('common.company_id') }}</th>
                                        <th>{{ __('common.company') }}</th>
                                        <th>{{ __('common.short_name') }}</th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                ajax: {
                    url: "{{ admin_url('master/company/list') }}",
                    type: 'POST',
                    headers: {
                ...
                buttons: [{
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    var exportUrl =
                                        "{{ admin_url('master/company/export/pdf') }}";
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    var formData = $('#formsearch').serialize();
                                    var exportUrl =
                                        "{{ admin_url('master/company/export/excel') }}";
                                    window.location.href = exportUrl + '?search=' +
                                        searchValue + '&' +
                                        formData;
                                }
            ...
            $(document).on('click', '.statusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('master/company/status') }}",
                            type: 'post',
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('master/company/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')

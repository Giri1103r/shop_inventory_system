...
@section('pageurl', admin_url('master/department/list'))
                ...
                <div class="card">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2 p-2">
                        ...
                        @if (CheckUserPermission('export'))
                            <x-button-import href="{{ admin_url('master/department/import') }}"></x-button-import>
                        @endif
                        @if (CheckUserPermission('add'))
                            <x-button-add dataId="" class="add btn btn-primary ms-1"
                                href="{{ admin_url('master/department/add') }}">{{__('common.add')}}</x-button-add>
                        @endif
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="department_id" class="form-label ">{{__('common.department_id')}}</label>
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="department_name" class="form-label ">{{__('common.department')}}</label>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('master/department/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('master/department/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('master/department/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&department_id=' + department_id +
                                            '&company_id=' + company_id +
                                            '&location_id=' + location_id +
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('master/department/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('master/department/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

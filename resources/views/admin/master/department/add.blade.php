...
@section('title', 'Department Master Add')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="align-back-btc d-flex justify-content-end align-items-center">
                                    <x-button-back href="{{ admin_url('master/department/list') }}"></x-button-back>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="departmentadd"
                                        action="{{ admin_url('master/department/add/submit') }}">
                                        @csrf
                                        ...
                                        <div class="submit-button" style="text-align: right;">
                                            ...
                                            <x-button-cancel href="{{ admin_url('master/department/list') }}"></x-button-cancel>
                                        </div>
            ...
            $('#departmentadd').validate({
                rules: {
                    ...
                    department_name: {
                        ...
                        maxlength: 70,
                        remote: {
                            url: '{{ admin_url('master/department/unique') }}',
                            type: 'post',
                            data: {
                                company_id: function() {

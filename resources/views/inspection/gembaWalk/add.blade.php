                                                ...
                                                <div id="gemba_walk_checklist">
                                                    ...
                                                    <div class="row gemba_walk_checklist_add " data-index="0">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mt-2">
                                                                <div class="form-group form-input">
                                                                    <label class="form-label require ">Observation
                                                                        Time</label>
                                                                    <input type="text" name="gemba_walk[0][time]"
                                                            ...
                                                            <div class="col-md-4 mt-2 form-input file-upload-block"
                                                                id="closing-file-upload-0" style="display: none;">
                                                                <label for="closing_evidence_0"
                                                                    class="form-label require">
                                                                    {{ __('inspection.closing_evidence') }}
                                                                </label>
                                                                <input type="file" class="form-control"
                                                                    name="gemba_walk[0][closing_evidence]"
                                                                    id="closing_evidence_0">
                                                                <div class="text-danger"></div>
                                                            </div>
    ...
    <script type="text/javascript" nonce="projectcab">
        ...
        $(document).ready(function() {
            function toggleFileUpload(index) {
                const status = $(`#current_status_${index}`).val();
                if (status == '2') {
                    $(`#closing-file-upload-${index}`).show();
                } else {
                    $(`#closing-file-upload-${index}`).hide();
                }
            }
            ...
            // Listen to changes
            $('#current_status_0').on('change', function() {
                toggleFileUpload(0);
            });
        });

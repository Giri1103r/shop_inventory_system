...
@section('content')
    ...
    @push('script')
        ...
        //                                             <label
        //                                                 class="form-label require">{{ __('inspection.unit1') }}</label>
        //                                             <select name="unit_1[1][1]" id="unit1[1][[${form_set_count}]]"
        ...
        //                                         <label
        //                                             class="form-label require">{{ __('inspection.unit2') }}</label>
        //                                         <select name="unit_2[1][[${form_set_count}]]" id="unit2[1][[${form_set_count}]]"
        ...
        //                                         <label
        //                                             class="form-label require">{{ __('inspection.unit3') }}</label>
        //                                         <select name="unit_3[1][[${form_set_count}]]" id="unit3[1][[${form_set_count}]]"
        ...
        //                                         <label
        //                                             class="form-label require">{{ __('inspection.unit4') }}</label>
        //                                            <select name="unit_4[1][[${form_set_count}]]" id="unit4[1][[${form_set_count}]]"
        ...
        //                                         <label
        //                                             class="form-label require">{{ __('inspection.total_quantity') }}</label>
        //                                         <input name="total_quantity[1][${form_set_count}]" id="total_quantity"
        //                                             class="form-control" style="resize: none;" />
        //                                     </div>
        //                                 </div>
        //                             </div>

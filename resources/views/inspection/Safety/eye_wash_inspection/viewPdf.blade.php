...
<body>
    ...
    <table width="100%" style="width:100%;">
        ...
        <tr>
            ...
            <td width="2%" style="padding:5px;">:</td>
            <td width="48%" style="padding:5px;">
                {{ isset($inspection_details->revision_date) ? $inspection_details->revision_date : '' }}
            </td>
        </tr>
        <tr>
        ...
        <table width="100%" style="width:100%;">
            ...
            @if (isset($inspection_details->created_at))
                <tr>
                    ...
                    <td width="2%" style="padding:5px;">:</td>
                    <td width="48%" style="padding:5px;"> {{ Displaydateformat($inspection_details->created_at) }}
                    </td>
                </tr>
            @endif
    ...
    @if (isset($inspection_details->level_one_manager_remarks))
        ...
        <table width="100%" style="width:100%;">
            <tr>
                ...
                <td width="2%" style="padding:5px;">:</td>
                <td width="48%" style="padding:5px;">
                    {{ getUserName($inspection_details->l1_manager_verified_by) }}</td>
            </tr>
            <tr>
                <td width="50%" style="padding:5px;"><b>{{ __('inspection.date') }}</b></td>
                <td width="2%" style="padding:5px;">:</td>
    ...
    @if (isset($inspection_details->level_two_manager_remarks))
        ...
        <table width="100%" style="width:100%;">
            <tr>
                ...
                <td width="2%" style="padding:5px;">:</td>
                <td width="48%" style="padding:5px;">
                    {{ getUserName($inspection_details->l2_manager_verified_by) }}</td>
            </tr>
            <tr>
                <td width="50%" style="padding:5px;"><b>{{ __('inspection.date') }}</b></td>
                <td width="2%" style="padding:5px;">:</td>

...
@section('title', 'Compliance Category List')
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('audit/master/compliance_category/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>{{ __('inspection.compliance_category') }}</th>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('audit/master/compliance_category/list') }}",
                        type: 'POST',
                        headers: {
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    if (types == 1) {
                        var title = '{{ __('inspection.compliance_category_inactive_msg') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('audit/master/compliance_category/status') }}",
                                type: 'post',
                                data: {
                                    id: id,
                                    types: types
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    var title = '{{ __('Do You want to Delete the Compliance Category') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('audit/master/compliance_category/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

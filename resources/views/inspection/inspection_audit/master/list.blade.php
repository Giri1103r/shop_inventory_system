...
@section('title', 'Audit Task Master')
@section('pageurl', admin_url('audit/master/task/list'))
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('audit/master/task/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('audit/master/task/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('audit/master/task/export/pdf') }}" +
                                            '?search=' + searchValue +
                                            '&task_id=' + task_id +
                                            '&from_date=' + from_date +
                                            '&to_date=' + to_date +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('audit/master/task/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&task_id=' + task_id +
                                            '&from_date=' + from_date +
                                            '&to_date=' + to_date +
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    if (types == 1) {
                        var title = '{{ __('Do You want to In-Activate Audit Task') }}';
                        var text = '{{ __('common.inactive') }}';
                        var btncolor = '#dc3545'

                    } else {
                        var title = '{{ __('Do You want to Activate Audit Task') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('audit/master/task/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    var title = '{{ __('Do You want to Delete  Audit Task Record') }}';
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('audit/master/task/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

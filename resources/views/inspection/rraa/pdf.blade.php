...
<body>
    ...
    @foreach ($content as $rraa_details)
        <br>
        <div style="width:100%;">
        ...
        <table
            ...
            <tr>
                ...
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">SCOPE
                </th>
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">RESPONSIBILITY
                </th>
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">AUTHORITY
                </th>
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">ACCOUNTABILITY
                </th>

                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4 mb-3 form-input">
                                            ...
                                            <select name="category" class="form-control single-select" id="category"
                                                style="width: 100%">
                                        ...
                                        <div class="col-md-4 mb-3 form-input">
                                            <label for="ohs_compliance_index" class="form-label ">OHS Compliance
                                                Index(Role)</label>
                            ...
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>Category</th>
                                        <th>OHS Compliance Index(Role)</th>
                                        <th>Frequency</th>
                                        <th>Scope</th>

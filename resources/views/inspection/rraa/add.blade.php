                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="rraa_Add"
                                        action="{{ admin_url('rraa/ohc_fire_environment_compliance/add/submit') }}"
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div id="form-wrapper">
                                                <div class="card-header-inner d-flex justify-content-between">
                                                    <h4 class="text-white ms-2">RRAA CheckList</h4>
                                                ...
                                                <div class="form-set mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group form-input">
                                                                <label class="form-label require">OHS Compliance
                                                                    Index(Role)</label>
                                                        ...
                                                        <div class="col-md-4 mt-2">
                                                            <div class="form-group form-input">
                                                                ...
                                                                <select name="emp_id[1]" id="emp_id"
                                                                    class="form-control single-select emp-select"
                                                                    style="width:100%">
                                                        ...
                                                        <div class="col-md-4 mt-2 file-upload-block form-input"
                                                            id="file-upload-0">
                                                            <label for="rraa_files" class="form-label require ">Upload
                                                                File</label>
 ...
 <button class="btn btn-danger remove-row" type="button"
            ...
            function updatePageIndices() {
                $('#form-wrapper .form-set').each(function(index) {
                    $(this).find("input[name^='serial_number']").val('RRAA-' + ('0000' + (index + 1)).slice(
                        -5));

                    $(this).find('input[name^="serial_number"]').attr('name', 'serial_number[' + (index +
                        1) + ']');
                    $(this).find('input[name^="scope"]').attr('name', 'scope[' + (index + 1) + ']');
                    $(this).find('input[name^="ohs_compliance_index"]').attr('name',
                        'ohs_compliance_index[' + (index + 1) + ']');
                    ...
                    $(this).find('input[name^="accountability"]').attr('name', 'accountability[' + (index +
                        1) + ']');

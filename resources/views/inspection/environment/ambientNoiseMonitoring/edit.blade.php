...
@section('title', 'Ambient Noise Monitoring Edit')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="align-back-btc">
                                    <x-button-back
                                        href="{{ admin_url('environment/ambient-noise/list') }}"></x-button-back>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="editchecklist"
                                        action="{{ admin_url('environment/ambient-noise/edit/submit') }}">
                                        @csrf
        ...
        $(document).on("click", ".removeeditrow", function() {
            ...
            if (rowId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('environment/ambient-noise/deleteChecklist') }}/" +
                                rowId,
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',

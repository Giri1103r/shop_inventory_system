...
@section('title', 'Ambient Noise Monitoring Import')
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-end p-2 gap-2">
                                    <x-button-download href="{{ admin_url('environment/ambient-noise/sampledownload') }}"></x-button-download>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="unitimport" enctype="multipart/form-data"
                                        action="{{ admin_url('environment/ambient-noise/import/submit') }}">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="submit-button" style="text-align: right;">
                                            ...
                                            <x-button-cancel href="{{ admin_url('environment/ambient-noise/list') }}"></x-button-cancel>

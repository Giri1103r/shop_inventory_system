...
<body>
    ...
    <table
        ...
        <tr>
            ...
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">LOCATION</th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="3">UNIT</th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="3">NOISE LEVEL
                (dBA)
            </th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">DATE OF
                MONITORING
            </th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">NEXT DUE DATE
                OF MONITORING
            </th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="3">NOISE LEVEL
                (dBA) (DAY)
            ...
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">LAST DUE DATE
                OF MONITORING
            </th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">ACT/RULE
            </th>
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">REMARKS
            </th>
        </tr>
        @foreach ($ambientNoiseDataList as $list)
            <tr>
                <td style="border: 1px solid black; padding: 8px;" colspan="2">{{ $list->sr_no }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="4">{{ $list->location_name }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="3">{{ $list->unit_name }}</td>
                <td style="border: 1px solid black; padding: 8px;" colspan="3">
                    {{ $list->noise_level_dba }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="4">
                    {{ Displaydateformat($list->date_of_monitoring) }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="4">
                    {{ Displaydateformat($list->next_due_date_of_monitoring) }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="3">
                    {{ $list->noise_level_dba_day }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="3">
                    {{ $list->noise_level_dba_night }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="4">
                    {{ Displaydateformat($list->date_of_monitoring_date) }}
                </td>
                <td style="border: 1px solid black; padding: 8px;" colspan="4">
                ...
                <td style="border: 1px solid black; padding: 8px;" colspan="4">{{ $list->remark }}
                </td>
            </tr>
        @endforeach

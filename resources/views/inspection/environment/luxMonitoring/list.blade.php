                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('environment/lux/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="environment_no" class="form-label">Lux Monitoring Id                                            </label>
                                            <select name="environment_no" id="environment_no" class=" form-control single-select"
                                                style="width: 100%">
                                                <option value="">Selecte Lux Monitoring </option>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('environment/lux/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('environment/lux/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('environment/lux/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&environment_no=' + environment_no +
                                            '&status=' + status
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('environment/lux/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('environment/lux/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

...
@section('title', 'Lux Monitoring Add')
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="addambient"
                                        action="{{ admin_url('environment/lux/add/submit') }}">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                        ...
                                        <div class="submit-button" style="text-align: right;">
                                            ...
                                            <x-button-cancel
                                                href="{{ admin_url('environment/lux/list') }}"></x-button-cancel>
                                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateRowIndexes() {
                $("#lesson_learned_block .lesson_learned_row").each(function(index) {
                    ...
                    let srNoValue = "LUX-" + String(newIndex).padStart(4, '0');

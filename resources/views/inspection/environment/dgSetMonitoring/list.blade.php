...
@section('title', 'DG Set Stack Emission Monitoring')
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('environment/dg-set-stack-emission/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="environment_no" class="form-label">DG Set Stack Emission Monitoring Id                                            </label>
                                            <select name="environment_no" id="environment_no" class=" form-control single-select"
                                                style="width: 100%">
                                                <option value="">Selecte DG Set Stack Emission Monitoring </option>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>DG Set Stack Emission Monitoring Id</th>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('environment/dg-set-stack-emission/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('environment/dg-set-stack-emission/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('environment/dg-set-stack-emission/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&environment_no=' + environment_no +
                                            '&status=' + status
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('environment/dg-set-stack-emission/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('environment/dg-set-stack-emission/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

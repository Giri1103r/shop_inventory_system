                                    ...
                                    <hr> --}}
                                        ...
                                        @foreach ($inspection_details as $details)
                                            <div class="row mt-4 form-set">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label class="form-label ">{{ __('inspection.glass') }}</label>
                                                        <div class="view_data">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label class="form-label ">{{ __('inspection.hammer') }}</label>
                                                        <div class="view_data">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label
                                                            class="form-label ">{{ __('inspection.mannual_call_point') }}</label>
                                                        <div class="view_data">

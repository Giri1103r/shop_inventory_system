                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('fire/fire-modular-inspection/checklist/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('fire/fire-modular-inspection/checklist/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('fire/fire-modular-inspection/checklist/export/pdf') }}" +
                                            '?search=' + searchValue +
                                ...
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('fire/fire-modular-inspection/checklist/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&inspection_date=' + inspection_date +
                                            '&next_due=' + next_due +
                                            '&location=' + location_id +
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/fire-modular-inspection/checklist/list/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/fire-modular-inspection/checklist/list/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

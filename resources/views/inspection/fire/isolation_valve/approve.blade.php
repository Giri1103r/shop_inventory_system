                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-wrapper">
                                            <div class="row mt-4 form-set">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label
                                                            class="form-label">{{ __('inspection.location_isv') }}</label>
                                                        <div class="view_data">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label
                                                            class="form-label ">{{ __('inspection.wheel_operation') }}</label>
                                                        <div class="view_data">
                                ...
                                @if (
                                    ...
                                    <form method="POST" id="capaAction"
                                        action="{{ admin_url('fire/isolating-valve-inspection/capa/submit') }}"
                                        autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" value="{{ encryptId($inspection->id) }}" name="id">
                                        <div class="row">

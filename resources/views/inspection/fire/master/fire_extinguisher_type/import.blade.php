                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-end p-2 gap-2">
                                    <x-button-download href="{{ admin_url('fire/master/fire_extinguisher-type/sampledownload') }}"></x-button-download>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="fireExtinguisher" enctype="multipart/form-data"
                                        action="{{ admin_url('fire/master/fire_extinguisher-type/import/submit') }}">
                                        @csrf
                                        <div class="row">

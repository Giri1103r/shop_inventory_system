                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="fire_extinguisher_id" class="form-label">Fire Extinguisher Type ID</label>
                                            <input type="text" name="fire_extinguisher_id" id="fire_extinguisher_id" class="form-control"
                                                placeholder="Fire Extinguisher Type ID">
                                        </div>
                                        <div class="col-md-3 mb-3 form-input">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>Fire Extinguisher Type ID</th>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                ajax: {
                    url: "{{ admin_url('fire/master/fire_extinguisher-type/list') }}",
                    type: 'POST',
                    headers: {
                    ...
                    data: function(d) {
                        d.fire_extinguisher_id = $('#fire_extinguisher_id').val();
                        d.fire_extinguisher_name = $('#fire_extinguisher_name').val();
                        d.status = $('#status').val();
                ...
                columns: [{
                    ...
                    {
                        data: 'fire_extinguisher_id',
                        name: 'fire_extinguisher_id'
                    },
                    {
                        data: 'fire_extinguisher_name',
                        name: 'fire_extinguisher_name'
                    },
                    {
                        data: 'status',
                        name: 'status'
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('fire/master/fire_extinguisher-type/export/pdf') }}" +
                                        '?search=' + searchValue +
                                        '&fire_extinguisher_id=' + fire_extinguisher_id +
                                        '&fire_extinguisher_name=' + fire_extinguisher_name +
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    $('body').click();
                                    window.location.href =
                                        "{{ admin_url('fire/master/fire_extinguisher-type/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&fire_extinguisher_id=' + fire_extinguisher_id +
                                        '&fire_extinguisher_name=' + fire_extinguisher_name +
            ...
            $(document).on('click', '.statusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('fire/master/fire_extinguisher-type/status') }}",
                            type: 'post',
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('fire/master/fire_extinguisher-type/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')

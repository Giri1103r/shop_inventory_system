                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="fireExtinguisher" action="{{ admin_url('fire/master/fire_extinguisher-type/add/submit') }}">
                                        @csrf

                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    <label class="form-label require">Fire Extinguisher ID</label>
                                                    <input type="text" name ="fire_extinguisher_id" class="form-control"
                                                        placeholder="Fire Extinguisher ID" value="{{ getsequence('FireExtinguisher') }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group form-input">
                                                    ...
                                                    <input type="text" name="fire_extinguisher_name" id="fire_extinguisher_name"
                                                        class="form-control" placeholder="Fire Extinguisher Type">
                                                </div>
                                            </div>

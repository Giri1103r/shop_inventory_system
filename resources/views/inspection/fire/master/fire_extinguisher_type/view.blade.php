                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">{{ __('Fire Extinguisher Type ID') }}</label>
                                        <div class="view_data">
                                            {{ isset($fireExtinguisherType->fire_extinguisher_id) ? $fireExtinguisherType->fire_extinguisher_id : '' }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        ...
                                        <div class="view_data">
                                            {{ getusername($fireExtinguisherType->created_by) }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">{{ __('common.created_date') }}</label>
                                        <div class="view_data">
                                            {{ displayDateformat($fireExtinguisherType->created_at) }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                        <label class="form-label view_label">{{ __('common.status') }}</label>
                                        <div class="view_data">
                                            @if ($fireExtinguisherType->status == 1)
                                                {{ __('common.active') }}
                                            @else
                                                {{ __('common.inactive') }}
                                            @endif

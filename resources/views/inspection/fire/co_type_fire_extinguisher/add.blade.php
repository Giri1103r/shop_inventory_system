...
@section('title', 'Co2 Type Fire Extinguisher Inspection')
                                    ...
                                    <form method="POST" id="cotypefireAdd"
                                                ...
                                                <div class="form-group form-input">
                                                    ...
                                                    <div class="input-group date form-input  custom-height">
                                                        <input type="text" name="inspection_date" id = "inspection_date"
                                                            placeholder="Date Of Inspection" class="form-control"
                                        ...
                                        <div class="form-wrapper">
                                            <div class="row mt-4 form-set">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label class="form-label require">Discharge Horn</label>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        <label class="form-label require">Weight of CO2 in FE</label>
                                                        <input type="text" name="weight_of_co2_in_fe[1]"
                                                            id="weight_of_co2_in_fe" placeholder="Weight of CO2 in FE"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="form-group form-input">
                                                        ...
                                                        <input type="text" name="approach[1]" id="approach"
                                                            placeholder="Approach" class="form-control">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-observation">
                                            <div class="row mt-4 form-obs">
                                                <div class="card-header-inner p-2">
                                                    <h4 class="text-white">
                                                        {{ __('inspection.co_type_fire_extinguisher_inspection_obs') }}
                                                    </h4>
                                                </div>
                                        ...
                                        <div class="submit-button" style="text-align: right;">
                                            ...
                                            <x-button-cancel
                                                href="{{ admin_url('fire/fire-extinguisher/co2/list') }}"></x-button-cancel>
                                        </div>
                        ...
                        <div class="row mt-4 form-set">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group form-input">
                                    ...
                                    <input type="text" name="fire_point_no[${form_set_count}]" id="fire_point_no-${form_set_count}"
                                    placeholder="Fire Point No" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group form-input">
                                    ...
                                    <input type="text" name="capacity[${form_set_count}]" id="capacity-${form_set_count}"
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group form-input">
                                    ...
                                    <input type="text" name="quantity[${form_set_count}]" id="quantity-${form_set_count}"
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group form-input">
                                    ...
                                    <input type="text" name="weight_of_co2_in_fe[${form_set_count}]" id="weight_of_co2_in_fe-${form_set_count}"
                                    placeholder="Weight of CO2 in FE" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group form-input">

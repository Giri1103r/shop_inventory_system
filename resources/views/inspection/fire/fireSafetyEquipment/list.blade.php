                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('fire/fire-safety/equipments/code-sheet/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            <label for="fire_no" class="form-label">Fire Safety Equipments Id                                            </label>
                                            <select name="fire_no" id="fire_no" class=" form-control single-select"
                                                style="width: 100%">
                                                <option value="">Selecte Fire Safety Equipments </option>
                                                @foreach ($fireList as $list)
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>Fire Safety Equipments Id</th>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('fire/fire-safety/equipments/code-sheet/list') }}",
                        type: 'POST',
                        headers: {
                            ...
                            buttons: [{
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        window.location.href =
                                            "{{ admin_url('fire/fire-safety/equipments/code-sheet/export/pdf') }}" +
                                            '?search=' + searchValue +
                                            '&fire_no=' + fire_no +
                                            '&status=' + status
                                    }
                                },
                                {
                                    ...
                                    action: function(e, dt, button, config) {
                                        ...
                                        $('body').click();
                                        window.location.href =
                                            "{{ admin_url('fire/fire-safety/equipments/code-sheet/export/excel') }}" +
                                            '?search=' + searchValue +
                                            '&fire_no=' + fire_no +
                                            '&status=' + status
                                    }
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/fire-safety/equipments/code-sheet/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/fire-safety/equipments/code-sheet/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

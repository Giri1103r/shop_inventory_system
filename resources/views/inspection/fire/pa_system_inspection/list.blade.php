...
@section('title', 'Fire PA System Inspection')
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('fire/pa-system-inspection/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                                            ...
                                            <div class="form-group form-input">
                                                ...
                                                <div class="input-group date form-input custom-height">
                                                    <input type="text" name="date_of_inspection"
                                                        id = "date_of_inspection" class="form-control">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('fire/pa-system-inspection/list') }}",
                        type: 'POST',
                        headers: {

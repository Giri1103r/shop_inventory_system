...
@section('content')
            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                @if (
                                        ...
                                        <form method="POST" id="forklistassessmentAdd"
                                            ...
                                            <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group form-input">
                                                            <input type="text" name="why_4" class="form-control">
                                                        </div>
                                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group form-input">
                                                        <input type="text" name="why_5" class="form-control">
                                                    </div>
                                                 </td>
                                    ...
                                    <tr class="table-light fw-semibold">
                                        ...
                                        <td>
                                            <div class="form-group form-input">
                                                <input type="text" name="main_root_cause" class="form-control">
                                            </div>
                                        </td>
                ...
                <div class="row">
                    <div class="col-md-4 form-group form-input mb-2">
                        ...
                        <input type="text" name="ehs_verify_by" id = "name" class="form-control"
                ...
                <div class="submit-button" style="text-align: right;">
                    ...
                    <x-button-cancel href="{{ admin_url('fire/checklist-observation/list') }}"></x-button-cancel>
                </div>
            </div>
            </form>
        </div>
    @else
                            ...
                            <table class="table table-sm table-bordered align-middle">
                                ...
                                <tbody id="whywhyanalysisBody">
                                    <tr>
                                        ...
                                        <td><input type="text" name="why_1" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="why_2" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="why_3" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="why_4" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="why_5" class="form-control"
                                    ...
                                    <tr class="table-light fw-semibold">
                                        ...
                                        <td><input type="text" name="main_root_cause" class="form-control"
                                                value="{{ $observation->main_root_cause }}" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="table-light fw-semibold">
                                        ...
                                        <td><input type="text" name="corrective_action" class="form-control"
                                                value="{{ $observation->corrective_action }}" readonly></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        @if (
            ($observation->observation_status == WAITING_FOR_CAPA_ACTION && CheckuserRole(ROLE_FIRE_ASSOCIATES)) ||
                ($observation->observation_status == WAITING_FOR_CAPA_ACTION && CheckuserRole(ROLE_SUPERADMIN)))
            <div class="basic-form mx-3">
                <div class="row mt-3">
                    <div class="card-header-inner">
                ...
                <form method="POST" id="capaAction" action="{{ admin_url('fire/checklist-observation/capa/submit') }}"
                    autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{ encryptId($observation->inspectionid) }}" name="id">
                    <input type="hidden" value="{{ encryptId($observation->observationid) }}" name="observation_id">
                    <div class="row">
                        <div class="col-md-4 form-group form-input mb-2">
                            <label class="form-label ">{{ __('inspection.name') }}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-input">
                                ...
                                <input type="text" name="closed_date" id="closed_date" class="form-control">
                            </div>
                        </div>
                        <div class = "row">
                            <div class="col-md-4 form-group form-input">
                                <label for="capa_status" class="form-label ">{{ __('common.status') }}</label>
        ...
        @if (
            ...
            <div class="basic-form mx-3">
                <form method="POST" id="forklistassessmentAdd"
                    action="{{ admin_url('fire/checklist-observation/capa/reverify/submit') }}" autocomplete="off"
        ...
        @if (
            ($observation->observation_status == WAITING_FOR_L1_VERIFICATION && CheckuserRole(ROLE_L1_MANAGER)) ||
                ($observation->observation_status == WAITING_FOR_L1_VERIFICATION && CheckuserRole(ROLE_SUPERADMIN)))
            <div class="basic-form mx-3">
                <form method="POST" id="levelOneManager"
                    action="{{ admin_url('fire/checklist-observation/level-one/verify/submit') }}" autocomplete="off"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{ encryptId($observation->inspectionid) }}" name="id">
                    <input type="hidden" value="{{ encryptId($observation->observationid) }}" name="observation_id">
        ...
        @if (
            ($observation->observation_status == WAITING_FOR_L2_VERIFICATION && CheckuserRole(ROLE_L2_MANAGER)) ||
                ($observation->observation_status == WAITING_FOR_L2_VERIFICATION && CheckuserRole(ROLE_SUPERADMIN)))
            <div class="basic-form mx-3">
                <form method="POST" id="levelTwoManager"
                    action="{{ admin_url('fire/checklist-observation/level-two/verify/submit') }}" autocomplete="off"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{ encryptId($observation->inspectionid) }}" name="id">
                    <input type="hidden" value="{{ encryptId($observation->observationid) }}" name="observation_id">
    ...
    <script>
        ...
        $('#forklistassessmentAdd').validate({
            ...
            messages: {
                ...
                why_1: {
                    required: "Why1 is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                why_2: {
                    required: "Why2 is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                why_3: {
                    required: "Why3 is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                why_4: {
                    required: "Why4 is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                why_5: {
                    required: "Why5 is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                corrective_action: {
                ...
                main_root_cause: {
                    required: "Main Root Access is Required",
                    minlength: "Minimum Characters should be 3",
                    maxlength: "Maximum Characters should not exceed 100",
                },
                target_date: {
                    required: "Target Date Access is Required",

                },
                responsible_person_id: {
                    required: "Responsible Person Access is Required",
        ...
        $('#capaAction').validate({
            ...
            messages: {
                ...
                capa_status: {
                    required: "CAPA Status is Required",
                },
                closed_date: {

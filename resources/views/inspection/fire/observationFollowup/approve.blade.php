...
@section('content')
                                                            ...
                                                            <table class="table table-sm table-bordered align-middle">
                                                                ...
                                                                <tbody id="whywhyanalysisBody">
                                                                    ...
                                                                    <tr class="table-light fw-semibold">
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group form-input"><input
                                                                                    type="text"
    ...
    @push('script')
        <script>
            $('#capa_status').change(function() {
                var selectedValue = $(this).val();

                if (selectedValue == '3') {
                    $('#closed_date').closest('.closed_date').show();
                } else {
                    $('#closed_date').closest('.closed_date').hide();
                }
            });

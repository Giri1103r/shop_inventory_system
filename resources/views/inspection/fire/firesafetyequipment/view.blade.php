                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="align-back-btc">
                                    <x-button-back href="{{ admin_url('fire/fire-safety/equipments/code-sheet/list') }}"></x-button-back>
                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="lesson_learned_block">
                                            @foreach ($fireSafetyEquipmentDataList as $fireSafetyEquipmentData)
                                                <div class="row lesson_learned_row" style="margin-top: 20px;">
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="" class="form-label">Name of Fire & Safety Equipment</label>
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->name_of_fire_safety ?? '-' }}
                                                        </div>
                                                    </div>

                                                    <div class="col-md-4 form-input">
                                                        <label for="" class="form-label">Resource Code No</label>
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->resource_code ?? '-' }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-input mt-2">
                                                        ...
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->series_code ?? '-' }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-input mt-2">
                                                        ...
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->unit_name ?? '-' }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 form-input mt-2">
                                                        <label class="form-label">Allotted Series Code</label>
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->allotted_series_code ?? '-' }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 form-input mt-2">
                                                        <label class="form-label">Total Allotted Code</label>
                                                        <div class="view_data">
                                                            {{ $fireSafetyEquipmentData->total_allotted_code ?? '-' }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 form-input mt-2">

...
@section('title', 'Certified Fire Fighter List')
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('fire/certified-fire-fighter/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3 form-input">
                                            ...
                                            <select name="fire_no" id="fire_no" class=" form-control single-select"
                                                style="width: 100%">
                                                <option value="">Selecte Certified Fire Fighter </option>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-list"
                                ...
                                <thead class="thead-primary">
                                    <tr>
                                        <th>{{ __('common.sno') }}</th>
                                        <th>Certified Fire Fighter Id</th>
        ...
        <script type="text/javascript" nonce="projectcab">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('fire/certified-fire-fighter/list') }}",
                        type: 'POST',
                        headers: {
                ...
                $(document).on('click', '.statusChange', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/certified-fire-fighter/status') }}",
                                type: 'post',
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('fire/certified-fire-fighter/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

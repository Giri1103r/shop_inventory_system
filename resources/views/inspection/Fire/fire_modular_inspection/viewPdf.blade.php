...
<body>
    ...
    <table
        ...
        <tr>
            ...
            <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" rowspan="2"
                colspan="3">DESCRIPTON
            </th>
            <th  style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" rowspan="1"
                colspan="3">CHECK ITEMS
            </th>

                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end p-2">
                        ...
                        <x-button-add dataId="" class="add btn btn-primary ms-1"
                            href="{{ admin_url('ohc/first-aid/opd-medicine-inspection/add') }}">Add</x-button-add>
                        {{-- @endif --}}
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var table = $('.datatable-list').DataTable({
                    ...
                    ajax: {
                        url: "{{ admin_url('ohc/first-aid/opd-medicine-inspection/list') }}",
                        type: 'POST',
                        headers: {
                ...
                $(document).on('click', '.recordDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ admin_url('ohc/first-aid/opd-medicine-inspection/list/delete') }}",
                                type: 'post',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                        .attr('content')

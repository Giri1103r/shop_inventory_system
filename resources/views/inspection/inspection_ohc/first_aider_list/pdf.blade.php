    ...
    @foreach ($content as $details)
        ...
        <tr>
            <th colspan="12"
                ...
                NEXT REVIEW DATE: {{ Displaydateformat($details->last_updated_date) ?? 'N/A' }}
            </th>
            <th colspan="12"
                style="border: 1px solid black; padding: 8px; background-color: #f2f2f2; text-align: left;">
                LAST UPDATED DATE: {{ Displaydateformat($details->next_review_date) ?? 'N/A' }}
            </th>
        ...
        <tr>
            ...
            @php
            $medicineRequisitionDetails = GetFirstAiderList($details->id);
        @endphp

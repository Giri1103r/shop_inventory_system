...
<head>
    <title>Monthly OHC Store Medicine Inspection Checklist| KARAM</title>
            ...
            <table style="width:100%;">
                <tr>
                    <td
                        ...
                        MONTHLY MEDICINE STORE INSPECTION CHECKLIST
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table width="100%" style="width:100%;">
            <tr>
                ...
                <th colspan="6" style="border:1px solid black; text-align: center;">
                    <h3><b>{{ __('title.medicine_store') }}</b></h3>
                </th>
                <th colspan="3" style="border:1px solid black; height:20px;">
                    <img src="{{ url('public/assets/images/plus-image.webp') }}" style="width:100px; height:50px;">
                </th>
        ...
        <table style="width: 100%; border-collapse: collapse; padding: 5px;">
            ...
            <tbody>
                ...
                {{-- @php
                    ...
                    $inspection_updated_by = GetOHCSignature(
                        $details->updated_by,
                        $details->id,
                        OHC_TYPE_MONTHLY_MEDICINE_STORE,
                    );

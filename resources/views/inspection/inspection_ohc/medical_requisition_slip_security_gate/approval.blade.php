                                    ...
                                    <div class="row">
                                        <div class="basic-form">
                                            <form method="POST" id="safetyofficerApprovalForm"
                                                ...
                                                action="{{ admin_url('ohc/medical-requisition-slip/fdo-security-gate/safetyofficerapproval/submit') }}">
                                                @csrf
                                                ...
                                                <div class="">
                                                    <div class="mb-3 row">
                                                        <div class="col-md-4 mb-3">
                                                            <label for="approver_name" class="form-label require">{{__('ohc_management.approver_name')}}</label>

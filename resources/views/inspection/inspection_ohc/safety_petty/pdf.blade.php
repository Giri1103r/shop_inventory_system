...
<head>
    <title>SAFETY PETTY LOGBOOK | KARAM</title>
            ...
            <table style="width:100%;">
                <tr>
                    <td
                        ...
                        {{ __('inspection.safety_petty_logbook') }}
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table
            ...
            <tr>
                ...
                <th colspan="25" style="border:1px solid black;">
                    <h3>
                        <span><b> {{ __('inspection.safety_petty_logbook') }}</b></span>
                        <br>
                    </h3>
                </th>
            ...
            <tr>
                ...
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4">EMPLOYEE NAME
                </th>
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="4"> EMPLOYEE CODE
                </th>
                ...
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">DATE
                </th>
                <th style="border: 1px solid black; padding: 8px; background-color: #f2f2f2;" colspan="5">AMOUNT
                </th>

                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4 form-input">
                                        ...
                                        <div class="view_data">
                                            {{ getDepartment(isset($medicinerequisition->first_aid_box_no	) ? $medicinerequisition->first_aid_box_no	 : '') }}
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-4 form-input">
                                ...
                                @if (
                                    (checkUserRole(ROLE_FLOOR_MANAGER) && $medicinerequisition->approve_status == MEDICINE_ASSISTANT_APPROVAL_PENDING)
                                       ||  (checkUserRole(ROLE_MEDICIAL_ASSISTANT) && $medicinerequisition->approve_status == MEDICINE_ASSISTANT_APPROVAL_PENDING) ||(checkUserRole(ROLE_SUPERADMIN) && $medicinerequisition->approve_status == MEDICINE_ASSISTANT_APPROVAL_PENDING))
                                    <div class="row">
                                        <div class="card-header-inner">
                                    ...
                                    <div class="row">
                                        <div class="basic-form">
                                            <form method="POST" id="safetyofficerApprovalForm"
                                                ...
                                                action="{{ admin_url('ohc/first-aid-box/daily-departmental/safetyofficerapproval/submit') }}">
                                                @csrf
                                ...
                                @if ($medicinerequisition->approve_status == MEDICINE_ASSISTAN_APPROVED)
                                    <div class="row">
                                        <div class="card-header-inner">
                                            <h4 class="text-white">Floor manager/Medical Assistant Approval</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="row">

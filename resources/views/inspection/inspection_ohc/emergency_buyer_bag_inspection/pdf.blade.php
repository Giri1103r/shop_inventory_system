...
<head>
    <title>Emergency Buyer First Aid Bag Checklist | KARAM</title>
            ...
            <table style="width:100%;">
                <tr>
                    <td
                        ...
                        BUYER'S FIRST AID BAG INSPECTION CHECKLIST
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table width="100%" style="width:100%; border-collapse: collapse; margin-top: 10px;">
            ...
            <tr>
                <td colspan="4" style="border: 1px solid black; padding: 5px;">
                    ...
                    {{ Displaydateformat($details->due_date) }}
                </td>
                <td colspan="4" style="border: 1px solid black; padding: 5px;">
                    <strong>Unit :-</strong>
                ...
                <td colspan="4" style="border: 1px solid black; padding: 5px;">
                    ...
                    {{ getFrequencyname($details->frequency_id) }}
                </td>
            </tr>
        </table>

...
<head>
    <title>Current New Ext Code Dialing | KARAM</title>
    ...
    <table width="100%" style="border-collapse: collapse; margin-top: 10px;">
        <tr>
            ...
            <td colspan="6" style="border:1px solid black; text-align: center;">
                <h3 style="margin:0;"><b>{{ __('title.code_dialing') }}</b></h3>
            </td>
        </tr>
    </table>
    ...
    <table class="table table-bordered table-hover tblborder" style="width:100%; border-collapse: collapse;" border="1">
        ...
        <tbody>
            ...
            <tr style="background-color: #ffb9bf; color: #fff; font-weight: bold;">
                <td colspan="10" style="text-align: center;"><b>{{ strtoupper($unitName) }}</b></td>
            </tr>
            
        
                @php
                    $groupedByDept = collect($records)->groupBy('department_name');
                @endphp
        
                @foreach ($groupedByDept as $deptName => $employees)

                    <tr style="background-color: #d6eaf8; font-weight: bold;">
                        <td colspan="10">{{ $deptName }}</td>
                    </tr>

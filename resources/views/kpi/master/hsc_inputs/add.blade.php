                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" id="hscinputsadd"
                                        action="{{ admin_url('kpi/hsc-inputs/add/submit') }}" autocomplete="off">
                                        @csrf
                                                ...
                                                <div class="form-group row">
                                                    @foreach ($leadings as $leading)
                                                        <div class="col-md-6 mb-3 form-input">
                                                            <label class="form-label">{{ $leading->value }}</label>
                                            ...
                                            <div class="col-md-12 container">
                                                <div class="form-group row">
                                                    @foreach ($laggings as $lagging)
                                                        <div class="col-md-6 mb-3 form-input">
                                                            <label class="form-label">{{ $lagging->value }}</label>
                                                            <input type="text" name="lagging_input[{{ $lagging->id }}]"
            ...
            $('#hscinputsadd').validate({
                rules: {
                    ...
                    month: {
                        required: true,
                        remote: {
                            url: "{{ admin_url('kpi/hsc-inputs/unique') }}",
                            type: 'post',
                            data: {
                                company_id: function() {

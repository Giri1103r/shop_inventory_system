...
<script>
    ...
    var chartData14 = new ApexCharts(document.querySelector("#chartData14"), options);
    chartData14.render();

    // Download button functionality
    $("#LoadChart14_download").off("click").on("click", function() {
        chartData14.dataURI().then(({
            imgURI
        }) => {

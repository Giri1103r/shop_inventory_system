<style type="text/css">
    ...
    #injury-model>.imgmap_css_container {
        width: 100% !important;
    }
...
<div id="injury" class="carousel slide" data-ride="carousel">
    <div class="row">

        <div class="col-lg-12 col-md-12 col-sm-12">
            <input type="hidden" name="imgMapdata" id="imgMapdata1" value="">
            <input type="hidden" name="humanbodyinjury" id="humanbodyinjury1" value="">
            <input type="hidden" name="humanbodyinjurylabel" id="humanbodyinjurylabel1" value="">

            <div class="img-content col-lg-4 col-md-4 col-sm-4" data-type='img-full'>
                <div class="img-map">
                ...
                <script type="text/template" id="tmp-male">
                         <div class="img-wrap male">
                                                   ...
                                                   <area alt="" onclick="changeImage('.male-face')"  title="Head" data-map="one"  shape="poly" coords="63,45,72,43,80,43,85,47,88,51,88,57,88,61,90,63,90,67,87,70,85,71,85,74,85,77,82,79,80,81,76,81,64,81,62,80,61,74,60,72,58,70,57,67,57,62,57,58,57,54,59,50,59,48" />
                                                   <area alt="" onclick="changeImage()"  title="Neck" data-map="Two" shape="poly" coords="62,82,82,81,81,91,63,90" />

                                                   <area alt="" onclick="changeImage()" title="Right Shoulder Front" data-map="three"  shape="poly" coords="62,88,73,91,72,107,28,108,34,99,42,96,49,96,57,94,59,93" />
                                                   <area alt="" onclick="changeImage()" title="Left shoulder Front" data-map="four"   shape="poly" coords="72,90,82,90,85,93,91,96,95,96,100,96,107,99,112,101,115,104,116,108,72,108" />
                                                   <area alt="" onclick="changeImage()" title="Right Arm Front" data-map="five"  shape="poly" coords="28,108,48,107,46,110,43,118,43,129,41,150,26,146,27,129" />
                                                   <area alt="" onclick="changeImage()" title="Left Arm Front" data-map="six"  shape="poly" coords="100,107,116,108,119,114,119,120,120,125,120,131,121,138,122,146,105,150,103,125,102,117,102,113" />
                                                   <area alt="" onclick="changeImage()" title="Right Elbow Front" data-map="seven"  shape="poly" coords="26,145,40,150,40,157,39,164,22,156,24,151" />
                                                   <area alt="" onclick="changeImage()" title="Left Elbow Front " data-map="eight"  shape="poly" coords="104,149,122,146,122,150,125,156,125,159,106,161" />
                                                   <area alt="" onclick="changeImage()" title="Right Forearm Front" data-map="nine"  shape="poly" coords="21,155,39,163,36,172,33,179,28,192,25,195,17,190,18,181,19,174,19,167" />
                                                   <area alt="" onclick="changeImage()" title="Left Forearm Front" data-map="ten"  shape="poly" coords="107,161,124,158,126,164,126,169,126,174,127,184,128,191,121,195,111,178" />
                                                   <area alt="" onclick="changeImage('.male-hand-right')" title="Right Hand " data-map="eleven"  shape="poly" coords="16,193,25,196,27,205,24,212,24,220,20,223,18,224,15,226,12,225,9,222,10,212,9,207,6,207,5,203,11,196" />
                                                   <area alt="" onclick="changeImage('.male-hand-left')" title="Left Hand" data-map="twelve"  shape="poly" coords="119,194,129,190,132,193,136,196,140,201,141,204,140,206,136,204,136,209,136,215,135,221,132,224,126,224,122,219,120,210" />
                                                   <area alt="" onclick="changeImage()" title="Right Chest" data-map="thirteen"  shape="poly" coords="46,108,44,115,43,125,43,135,72,135,71,108" />
                                                   <area alt="" onclick="changeImage()" title="Left Chest" data-map="fourteen"  shape="poly" coords="72,107,102,109,101,135,72,137" />
                                                   <area alt="" onclick="changeImage()" title="Stomach" data-map="fifteen"  shape="poly" coords="43,135,102,135,101,143,99,145,98,150,98,155,97,160,97,166,73,166,49,166,48,150" />
                                                   <area alt="" onclick="changeImage()" title="Right Hip" data-map="sixteen"  shape="poly" coords="48,166,72,166,72,189,45,189,48,173" />
                                                   <area alt="" onclick="changeImage()" title="Left Hip" data-map="seventeen"  shape="poly" coords="72,166,97,166,97,173,101,180,101,189,72,190" />
                                                   <area alt="" onclick="changeImage()" title="Pubis" data-map="eighteen"  shape="poly" coords="43,189,101,189,103,210,75,213,70,214,42,210,43,198" />
                                                   <area alt="" onclick="changeImage()" title="Left Thigh" data-map="nineteen"  shape="poly" coords="74,214,103,210,103,226,103,237,102,243,100,248,96,257,78,259,75,239" />
                                                   <area alt="" onclick="changeImage()" title="Right Thigh" data-map="twenty"  shape="poly" coords="49,259,66,259,69,253,69,247,69,239,69,230,71,215,42,211,42,235" />
                                                   <area alt="" onclick="changeImage()" title="Left Knee" data-map="twentyone"  shape="poly" coords="79,258,97,258,94,268,92,274,86,276,81,276" />
                                                   <area alt="" onclick="changeImage()" title="Right Knee" data-map="twentytwo"  shape="poly" coords="49,259,67,259,66,265,64,269,62,273,60,275,57,277,52,265" />
                                                   <area alt="" onclick="changeImage()" title="Left Leg "  data-map="twentythree"  shape="poly" coords="81,267,87,277,91,277,93,271,96,277,99,284,99,292,96,302,93,314,90,326,81,326,77,302,77,292" />
                                                   <area alt="" onclick="changeImage()" title="Right Leg " data-map="twentyfour"  shape="poly" coords="59,276,67,264,68,277,68,284,69,291,69,297,69,305,69,314,68,321,67,326,57,326,53,314,50,300,48,286,49,278,52,274,51,266,51,262" />
                                                   <area alt="" onclick="changeImage()" title="Right Ankle" data-map="twentyfive"  shape="poly" coords="56,326,67,326,67,343,55,341,58,334" />
                                                   <area alt="" onclick="changeImage()" title="Left Ankle" data-map="twentysix"  shape="poly" coords="80,327,89,327,92,345,80,343,78,345" />
                                                   <area alt="" onclick="changeImage('.male-foot-left')" title="Left Foot" data-map="twentyseven"  shape="poly" coords="79,342,91,342,98,350,100,354,99,357,85,357,78,357,78,353,76,350" />
                                                   <area alt="" onclick="changeImage('.male-foot-right')" title="Right Foot" data-map="twentyeight"  shape="poly" coords="54,342,66,342,69,353,69,356,58,356,47,356" />
                                                   <area alt="" onclick="changeImage()" title="Back Skull" data-map="twentynine"  shape="poly" coords="199,77,196,77,196,73,196,70,198,67,197,63,199,57,201,54,205,51,209,50,214,50,219,51,224,54,227,59,227,64,227,67,229,71,228,75,225,79,223,84,218,86,210,86,202,86" />
                                                   <area alt="" onclick="changeImage()" title="Back Neck" data-map="thirty"  shape="poly" coords="201,85,209,87,219,87,221,97,202,97" />
                                                   <area alt="" onclick="changeImage()" title="Left Shoulder Back" data-map="thirtyone"  shape="poly" coords="201,96,212,96,212,121,167,122,166,118,170,110,176,106,183,102,193,102" />
                                                   <area alt="" onclick="changeImage()" title="Right Shoulder Back" data-map="thirtytwo"  shape="poly" coords="211,96,222,96,226,100,234,102,240,103,246,105,253,109,256,115,256,121,212,121" />
                                                   <area alt="" onclick="changeImage()" title="Left Arm Back" data-map="thirtythree"  shape="poly" coords="167,120,184,121,182,128,184,143,179,163,163,156,168,136" />
                                                   <area alt="" onclick="changeImage()" title="Right Arm back" data-map="thirtyfour"  shape="poly" coords="241,121,257,122,261,156,245,163,239,145" />
                                                   <area alt="" onclick="changeImage()" title="Left Elbow back" data-map="thirtyfive"  shape="poly" coords="164,156,181,162,177,174,161,166" />
                                                   <area alt="" onclick="changeImage()" title="Right Elbow back" data-map="thirtysix"  shape="poly" coords="244,161,261,155,264,162,264,166,248,171,245,168" />
                                                   <area alt="" onclick="changeImage()" title="Left Forearm Back" data-map="thirtyseven"  shape="poly" coords="161,164,177,174,167,198,157,194,160,185,159,174" />
                                                   <area alt="" onclick="changeImage()" title="Right Forearm Back" data-map="thirtyeight"  shape="poly" coords="247,170,263,164,265,185,267,192,267,195,257,198,251,182,247,174" />
                                                   <area alt="" onclick="changeImage()" title="Upper Back " data-map="thirtynine"  shape="poly" coords="183,122,242,121,242,128,241,136,241,143,239,147,238,153,237,155,187,156,184,148,181,129" />
                                                   <area alt="" onclick="changeImage()" title="Lower Back"   data-map="forty"  shape="poly" coords="187,154,237,154,237,175,240,188,186,187,187,176" />
                                                   <area alt="" onclick="changeImage()" title="Left Buttock"  data-map="fortyone"  shape="poly" coords="185,188,211,188,213,212,209,215,208,218,181,217,183,202,184,199,184,195" />
                                                   <area alt="" onclick="changeImage()" title="Right Buttock"  data-map="fortytwo" shape="poly" coords="211,213,211,188,239,188,241,194,241,198,242,202,243,208,241,215,242,218,216,219" />
                                                   <area alt="" onclick="changeImage()" title="Left Thigh Back"  data-map="fortythree" shape="poly" coords="182,217,208,217,209,254,208,258,189,257,184,247,183,234,182,228" />
                                                   <area alt="" onclick="changeImage()" title="Right Thigh Back"  data-map="fortyfour" shape="poly" coords="213,218,242,218,241,230,241,243,236,256,217,256" />
                                                   <area alt="" onclick="changeImage()" title="Left Knee Back"  data-map="forty-five" shape="poly" coords="189,257,207,257,206,268,206,276,208,282,189,282,191,274,192,265" />
                                                   <area alt="" onclick="changeImage()" title="Right Knee Back"  data-map="fortysix" shape="poly" coords="215,257,237,257,233,263,232,270,232,277,234,282,218,281,218,275,219,264" />
                                                   <area alt="" onclick="changeImage()" title="Left Calf"  shape="poly" data-map="fortyseven" coords="189,282,207,282,208,288,209,295,209,304,207,312,206,325,195,326,193,316,189,301,188,293,187,286" />
                                                   <area alt="" onclick="changeImage()" title="Right Calf"  shape="poly"  data-map="fortyeight" coords="217,282,235,282,237,291,235,301,232,313,228,326,218,325,215,304,215,295" />
                                                   <area alt="" onclick="changeImage()" title="Left Ankle"  shape="poly"  data-map="fortynine" coords="195,324,206,323,207,336,198,336,196,335" />
                                                   <area alt="50" onclick="changeImage()" title="Right Ankle" coords="218,326,217,332,220,336,226,337,228,329,226,322" shape="poly" data-map="fifty"/>

                                                   <area  alt="51" onclick="changeImage()" title="Left heel" coords="200,342,195,354,195,346,200,358,204,354,206,346" shape="poly" data-map="fiftyone"/>
                                                   <area  alt="52" onclick="changeImage()" title="Right heel" coords="218,338,213,346,213,351,217,356,225,356,229,351,224,342" shape="poly" data-map="fiftytwo"/>
                                                   <area alt="53" onclick="changeImage()" title="Left Back Hand" shape="poly" data-map="fiftythree" coords="158,195,152,198,147,202,142,207,145,211,146,217,149,223,154,224,161,222,165,219,165,212,167,204,164,195">
                                                   <area alt="54" onclick="changeImage()" title="Right Back Hand" shape="poly" data-map="fiftyfour" coords="256,198,256,204,256,214,258,218,261,226,267,227,273,222,274,214,277,209,275,202,270,197,261,194">
                                                   <area alt="" onclick="changeImage()" title="Left Toe"  shape="poly" data-map="fiftyfive" coords="192,365,194,365,197,363,198,360,199,358,203,363,208,367,210,373,208,377,204,380,196,369" />
                                                   <area alt="" onclick="changeImage()" title="Right Toe"  shape="poly" data-map="fiftysix" coords="214,366,223,359,226,363,230,364,231,366,231,369,226,373,222,376,218,377,214,376,212,371" />
                ...
                <script type="text/template" id="tmp-female">
                         <div class="img-wrap female" >
                                                   ...
                                                   <area  alt="51" onclick="changeImage()" title="51. Left heel" coords="200,342,195,354,195,346,200,358,204,354,206,346" shape="poly" data-map="fiftyone" />
                                                   <area  alt="52" onclick="changeImage()" title="52. Right heel" coords="218,338,213,346,213,351,217,356,225,356,229,351,224,342" shape="poly" data-map="fiftytwo" />
                                                   <area alt="53" onclick="changeImage()" title="53. Left Back Hand" shape="poly" data-map="fiftythree" coords="158,195,152,198,147,202,142,207,145,211,146,217,149,223,154,224,161,222,165,219,165,212,167,204,164,195" />
                                                   <area alt="54" onclick="changeImage()" title="54. Right Back Hand" shape="poly" data-map="fiftyfour" coords="256,198,256,204,256,214,258,218,261,226,267,227,273,222,274,214,277,209,275,202,270,197,261,194" />
                                                   <area alt="" onclick="changeImage()" title="55. Left Toe"  shape="poly" data-map="fiftyfive" coords="192,365,194,365,197,363,198,360,199,358,203,363,208,367,210,373,208,377,204,380,196,369" />
                                                   <area alt="" onclick="changeImage()" title="56. Right Toe"  shape="poly" data-map="fiftysix" coords="214,366,223,359,226,363,230,364,231,366,231,369,226,373,222,376,218,377,214,376,212,371" />
                                                   </map>
                                                   </div></script>
                <!--female total parts -->

            </div>
            <div class="img-sgl-content col-lg-4 col-md-4 col-sm-4" data-type='img-full'>
                    ...
                    <div class="img-map-parts">
                        ...
                        <div class="parts male-foot-right">
                            ...
                            <img src="{{ admin_url('public/assets/images/human_body_parts/male/front/Right-Foot.png') }}"
                                usemap='#imgmap_css_container_imgmap201293016112' class='imgmap_css_container'
                                title='imgmap201293016112' alt='imgmap201293016112' id='img-imgmap201293016112' />
                            <map id='imgmap201293016112' data-map="foot-right"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="Right Finger 1" data-map='foot-right-finger1' shape="poly"
                        ...
                        <div class="parts male-foot-left">
                            ...
                            <map id='imgmap201293016112' data-map="foot-left"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="Left Finger 1" data-map='foot-left-finger1' shape="poly"
                                    coords="336,737,442,777,438,787,441,796,447,810,456,835,447,868,432,887,396,897,369,892,358,881,347,866,343,850" />
                                <area alt="" title="Left Finger 2" data-map='foot-left-finger2' shape="poly"
                                ...
                                <area alt="" title="Left Finger 3" data-map='foot-left-finger3' shape="poly"
                                    coords="540,779,598,756,618,798,627,835,637,861,622,874,596,876,582,872,574,868,553,801" />
                                <area alt="" title="Left Finger 4" data-map='foot-left-finger4' shape="poly"
                                    coords="598,760,636,730,660,766,674,788,684,808,683,821,680,836,666,844,645,847,632,830" />
                                <area alt="" title="Left Finger 5" data-map='foot-left-finger5' shape="poly"
                        ...
                        <div class="parts male-hand-right">
                            ...
                            <map id='imgmap201293016112' data-map="hand-right"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="Right Hand Palm" data-map='hand-right-palm'
                                    shape="poly"
                                ...
                                <area alt="" title="Right Thumb Finger" data-map='hand-right-thumb'
                                    shape="poly"
                                ...
                                <area alt="" title=" Right Index Finger" data-map='hand-right-index'
                                    shape="poly"
                                ...
                                <area alt="" title="Right Middle Finger" data-map='hand-right-middle'
                                    shape="poly"
                                ...
                                <area alt="" title="Right Ring Finger" data-map='hand-right-ring'
                                    shape="poly"
                                ...
                                <area alt="" title="Right Little Finger" data-map='hand-right-little'
                                    shape="poly"
                        ...
                        <div class="parts male-hand-left">
                            ...
                            <map id='imgmap201293016112' data-map="hand-left"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title=" Left Hand Palm" data-map='hand-left-palm'
                                    shape="poly"
                                ...
                                <area alt="" title="Left Thumb Finger" data-map='hand-left-thumb'
                                    shape="poly"
                                ...
                                <area alt="" title="Left Index Finger" data-map='hand-left-index'
                                    shape="poly"
                                ...
                                <area alt="" title="Left Middle Finger" data-map='hand-left-middle'
                                    shape="poly"
                                ...
                                <area alt="" title="Left Ring Finger" data-map='hand-left-ring'
                                    shape="poly"
                                ...
                                <area alt="" title="Left Little Finger" data-map='hand-left-little'
                                    shape="poly"
                        ...
                        <div class="parts female-foot-left">
                            ...
                            <map id='imgmap201293016112' data-map="foot-left"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="A. Left Finger 1" data-map='foot-left-finger1'
                                    shape="poly"
                                    coords="413,761,468,764,483,801,495,833,499,863,489,883,481,897,462,904,444,907,431,898,422,883,411,850,415,790" />
                                <area alt="" title="B. Left Finger 2" data-map='foot-left-finger2'
                                    shape="poly"
                                    coords="469,765,523,777,527,795,533,808,540,830,543,845,545,851,546,858,546,870,543,885,529,887,517,885,503,869,488,820" />
                                <area alt="" title="C. Left Finger 3" data-map='foot-left-finger3'
                                    shape="poly"
                                    coords="532,777,534,799,538,825,546,853,561,862,571,858,582,849,582,823,580,797,567,756" />
                                <area alt="" title="D. Left Finger 4" data-map='foot-left-finger4'
                                    shape="poly" coords="569,754,599,706,613,770,617,802,610,823,600,829,583,828" />
                                <area alt="" title="E. Left Finger 5" data-map='foot-left-finger5'
                                    shape="poly" coords="611,701,612,744,619,780,637,777,643,763,644,720,645,669" />
                            </map>
                        </div>
                        <div class="parts female-hand-right">
                            ...
                            <map id='imgmap201293016112' data-map="hand-right"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="A. Right Palm" data-map='hand-right-palm' shape="poly"
                        ...
                        <div class="parts female-hand-left">
                            ...
                            <map id='imgmap201293016112' data-map="hand-left"
                                name='imgmap_css_container_imgmap201293016112'>
                                <area alt="" title="A. Left Palm" data-map='hand-left-palm' shape="poly"
                                ...
                                <area alt="" title="B. Left Thumb Finger" data-map='hand-left-thumb'
                                    shape="poly"
                                ...
                                <area alt="" title="C. Left Index Finger" data-map='hand-left-index'
                                    shape="poly"
                                    coords="269,461,277,455,280,450,282,421,279,364,275,316,262,320,249,323,240,324,243,360,245,398,251,440,258,459" />
                                <area alt="" title="D. Left Middle Finger" data-map='hand-left-middle'
                                    shape="poly"
                                ...
                                <area alt="" title="E. Left Ring Finger" data-map='hand-left-ring'
                                    shape="poly"
                                    coords="155,308,172,317,189,324,190,339,186,371,181,400,180,423,176,451,171,462,164,463,153,456,151,422,151,374" />
                                <area alt="" title="F. Left Little Finger" data-map='hand-left-little'
                                    shape="poly"
                        ...
                        <div class="parts female-face">
                            ...
                            <map id='imgmap201293016112' data-map="head"
                                ...
                                <area alt="" title="O. Right Ear" data-map='O' shape="poly"
                                ...
                                <area alt="" title="P. Left Jaw" data-map='P' shape="poly"
                                    coords="320,452,252,450,254,427,347,430,334,441,327,450" />

                                <area alt="" title="Q. Right Jaw" data-map='Q' shape="poly"
                                    coords="182,452,254,453,254,430,158,429,161,439,174,447,181,452" />

                                <area alt="" title="R. Chin" data-map='R' shape="poly"
            ...
            <input type="hidden" name="inc_ids" id="inc_ids">

            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="table-container">
                    <table class="table table-bordered injtable table-scroll"
                        ...
                        <thead>
                            ...
                            <?php if(!empty($countBodyPart)){
                             $i =1;
                             foreach ($countBodyPart as $countpart){
                             $trname = str_replace(' ', '', $countpart['body_part']);?>
                            <?php
                            $class2 = '';
                            if ($i == 1) {
                                $class2 = 'topclass';
                            } ?>
                            <tr class="<?php echo $trname . '_tr' . ' ' . $class2; ?>">

                                <td><?php echo $countpart['body_part']; ?></td>
                                <td><?php echo $countpart['count']; ?></td>
        ...
        <script>
            ...
            $(document).on('click', '.getbody', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        injury_id: inval,
                        _token: '{{ csrf_token() }}' // Laravel Blade way to insert CSRF token
                    },
            ...
            $(document).on('click', '.injury-btn', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (empdat['empdata'] != null) {
                            $("#imgMapdata1").val('');
                            $("#imgMapdata1").val(empdat['empdata']['imgMapdata']);
                            $('.clearbodyparts').hide();
                            $("#injury_model [name='inc_body_id']").val(empdat['empdata']['id']);
                            $("#injury_model [name='injurydetails']").val(inval);

                        } else {
                            $('.clearbodyparts').hide();
                            $("#injury_model [name='inc_body_id']").val('');
                            $("#injury_model [name='injurydetails']").val(inval);
                        }
                        // alert(inval);
                        ...
                        if (inval != '' && inval != 0) {
                            ...
                            $('.save_inj').hide();
                            $('.draft_inj').show();
                            $(".draft_inj").attr("id", alt);
                            //alert($('#injury_body_parts_'+alt).val());

                            $("#imgMapdata1").val($('#injury_body_parts_' + alt).val());
                        }
                    }
            ...
            function get_emp_details_by_id(injuredPerson, acc_prim_id) {

                var accuniqueId = document.getElementById('accuniqueId').value;

                var url = "{{ admin_url('incident/initial-incident/fetchEmployeeDetails') }}";
                var data = {
                    partyname: injuredPerson,
                    acc_prim_id: acc_prim_id,
                    accuniqueId: accuniqueId,
                    _token: '{{ csrf_token() }}'
                };
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (empdat['empdata'] != '') {
                            ...
                            $("#imgMapdata1").val(empdat['empdata'][0]['imgMapdata']);
                            $("#body_prim_id").val(empdat['empdata'][0]['acc_body_id']);
            ...
            $("document").ready(function(e) {
                ...
                $(document).on('click', '.addbodyparts', function() {
                    ...
                    if (!allFilled) {
                        Swal.fire('Error', 'Please Enter The Body Parts Descriptions', 'error');
                    } else {
            ...
            $('.save_inj').click(function(e) {
                ...
                //alert('#inc_body_parts_' + $('#injurydetails').val());
                $('#inc_body_parts_' + $('#injurydetails').val()).val(commaSeparatedText);

                //$('#showhuman'+ $('#injurydetails').val()).html(commaSeparatedText);
                //$('#text_injbodypartlabel_'+ $('#injurydetails').val()).html(commaSeparatedText1);
                $('#text_injbodypart_' + $('#injurydetails').val()).val(commaSeparatedText);
                /**/
            ...
            $('.draft_inj').click(function(e) {
                //alert('test');
                var injurydetails = $('.injury_body_parts').attr('id');
                var res = injurydetails.split('_');
                //alert(injurydetails);
                var inval = res['3'];
                //alert(inval);
                ...
                //$('#injury_body_parts_0').val(data1);
                $('#injury_body_parts_' + $(this).attr('id')).val(data1);
                ...
                descLabels.each(function() {
                    labelTextArray.push($(this).text());
                });
                var commaSeparatedText = labelTextArray.join(", ");
                $('#inc_body_parts_' + $(this).attr('id')).val(commaSeparatedText);
                $('#humanbodyinjury1').val(commaSeparatedText);
                /**/
            ...
            function triggerMapClick1() {
                ...
                $("div.image-container .img-map-parts map area,div.img-content div.img-map map area").unbind('click');
                $("div.image-container .img-map-parts map area,div.img-content div.img-map map area").click(function() {
            ...
            function descBox1(point1, point2, desc) {
                ...
                div = $("<div/>");
                label = $("<label/>").text("" + $('[data-map~="' + point1 + '"] [data-map~="' + point2 + '"]').attr("title"))
                    .addClass("desc-label");
                console.log('gfdgf:')
            ...
            function descBox1_new(point1, point2, desc) {
                var is_ready_only = 1;
                //alert(is_ready_only);
                var div, label, point1, point2;
                var j = 0;
                ...
                if (is_ready_only != 1) {
                    buttons = $('<div><button type="button" class="fa fa-trash deletes" style="color:red;" alt="' + j +
                ...
                $(".img-desc .des_injury1_img").each(function(i, ele) {
                    ...
                    if (is_ready_only != 1) {
                        buttons = $('<div><button type="button" class="fa fa-trash deletes" style="color:red;" alt="' +
            ...
            function descBox(area, desc) {
                var div, label, point1, point2;

                div = $("<div/>");
                label = $("<label/>").text("" + $(area).attr("title") + ": ").addClass("desc-label");
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#imgcount').html(partcount);
                        var labelcount = $("<label/>").text("" + partcount).addClass("count-label");
                        $(div).append(label).append(labelcount).append(txtarea);
                        $(".img-desc").append(div);

                        $("#inc_ids").val(datas['inc_id']);

                        var blabel = titlestr.replace(/\s/g, '');
                        $('tr.' + blabel + '_tr').css('background-color', 'burlywood');
                        var $seltr = $('tr.' + blabel + '_tr');

                        var $firsttr = $('tr.topclass');
                        $('.injtable').find('tr.topclass').removeClass('topclass');
                        $('.injtable').find('tr.' + blabel + '_tr').addClass('topclass');

                        $seltr.insertBefore($firsttr);
                    }
                });

                if (desc !== undefined) {
                    // You can uncomment this if you want to pre-fill the textarea:
                    // $(txtarea).text(desc).val(desc);
                }
            }
            ...
            function changeImage(part) {
                ...
                if (part != undefined) {
                    ...
                    $('div.image-container .img-map-parts').prepend($("div.image-container .img-map-parts .parts" + part));
                }

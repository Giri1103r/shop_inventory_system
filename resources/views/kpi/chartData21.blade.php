...
<script>
    ...
    var chartData21 = new ApexCharts(document.querySelector("#chartData21"), options);
    chartData21.render();

    // Download button functionality
    $("#LoadChart21_download").off("click").on("click", function() {
        chartData21.dataURI().then(({
            imgURI
        }) => {

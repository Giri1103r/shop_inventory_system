...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
                    ...
                    $datatables = Datatables::of($data['data'])
                        ...
                        ->addColumn('action', function ($row) {
                            ...
                            if (CheckUserPermission('view')) {
                                $btn = '<a href="' . admin_url('master/company/view/' . encryptId($row->id)) . '"   class="" title="View"><i class="fa-solid fa-eye"></i></a> ';
                            }
                            if (CheckUserPermission('edit')) {
                                $btn .= '<a href="' . admin_url('master/company/edit/' . encryptId($row->id)) . '" class=" " title="Edit"><i class="fa-solid fa-pen-to-square"></i> ';
                            }
                            if (CheckUserPermission('delete')) {
                                $btn .= '<a href="javascript:void(0);" data-id="' . encryptId($row->id) . '" class="recordDelete" title="Delete"><i class="fa-solid fa-trash"></i></a> ';
                            }
                            return $btn;
                        })
        ...
        return view('admin.master.company.list', $data);
    }
    ...
    public function Add(Request $request)
    {
        ...
        try {
            ...
            $data = array();
            return view('admin.master.company.add', $data);
        } catch (Exception $ex) {
            report($ex);
            Session::flash('error', __('common.error_msg'));
            return redirect(admin_url('master/company/list'));
        }
    }
    ...
    public function View(Request $request)
    {
        try {
            ...
            return view('admin.master.company.view', $data);
        } catch (Exception $ex) {
            report($ex);
            Session::flash('error', __('common.error_msg'));
            return redirect(admin_url('master/company/list'));
    ...
    public function Edit(Request $request)
    {
        try {
            ...
            return view('admin.master.company.edit', $data);
        } catch (Exception $ex) {
            report($ex);
            Session::flash('error', __('common.error_msg'));
            return redirect(admin_url('master/company/list'));
    ...
    {
        $data = array();
        return view('admin.master.company.import', $data);
    }
    ...
    public function ExportPdf(Request $request)
    {
        ...
        try {
            ...
            $view = view('admin.master.company.pdf', $data);
            $html = $view->render();

...
class LocationController extends Controller
{
                    ...
                    $datatables = Datatables::of($data['data'])
                        ...
                        ->addColumn('action', function ($row) {
                            ...
                            if (CheckUserPermission('view')) {
                                $btn = '<a href="' . admin_url('master/location/view/' . encryptId($row->id)) . '"   class="" title="View"><i class="fa-solid fa-eye"></i></a> ';
                            }
                            if (CheckUserPermission('edit')) {
                                $btn .= '<a href="' . admin_url('master/location/edit/' . encryptId($row->id)) . '" class=" " title="Edit"><i class="fa-solid fa-pen-to-square"></i> ';
                            }
    ...
    public function Add(Request $request)
    {
        ...
        try {
            ...
            return view('admin.master.location.add', $data);
        } catch (Exception $ex) {
            report($ex);
            Session::flash('error', __('common.error_msg'));
            return redirect(admin_url('master/location/list'));
        }
    }
    ...
    public function View(Request $request)
    {
        try {
            ...
            return view('admin.master.location.view', $data);
        } catch (Exception $ex) {
            report($ex);
            Session::flash('error', __('common.error_msg'));
            return redirect(admin_url('master/location/list'));
    ...
    public function ExportPdf(Request $request)
    {
        ...
        try {
            ...
            $view = view('admin.master.location.pdf', $data);
            $html = $view->render();
    ...
    {
        $data = array();
        return view('admin.master.location.import', $data);
    }

...
class UnitController extends Controller
{
    ...
    public function index(Request $request)
    {
                    ...
                    $datatables = Datatables::of($data['data'])
                        ...
                        ->addColumn('action', function ($row) {
                            ...
                            if (CheckUserPermission('view')) {
                                $btn = '<a href="' . admin_url('unit/view/' . encryptId($row->id)) . '"   class="" title="View"><i class="fa-solid fa-eye"></i></a> ';
                            }
        ...
        return view('master.unit.list', $data);
    }
    ...
    public function View(Request $request)
    {
        try {
            ...
            return view('master.unit.view', $data);
        } catch (Exception $ex) {
            report($ex);
        }
    }
    ...
    public function ExportPdf(Request $request)
    {
        ...
        try {
            ...
            $view = view('master.unit.pdf', $data);
            $html = $view->render();
    ...
    {
        $data = array();
        return view('master.unit.import', $data);
    }

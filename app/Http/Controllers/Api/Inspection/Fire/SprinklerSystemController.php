            ...
            if (Auth::check()) {
                ...
                foreach ($details as $index => $values) {
                    ...
                    $inspection_details[$index + 1] = [
                        ...
                        'water_leakage' => $values->water_leakage == OK ? 'Ok' : 'Not Ok',
                        'quantity' => $values->quantity,
                        'painting' => $values->painting == OK ? 'Ok' : 'Not Ok',
                        'qbd' => $values->qbd == OK ? 'Ok' : 'Not Ok',
                        'condition_of_flow_meter' => $values->condition_of_flow_meter == OK ? 'Ok' : 'Not Ok',
                        'main_isolation' => $values->main_isolation == OK ? 'Ok' : 'Not Ok',
                        'drain_condition' => $values->drain_condition == OK ? 'Ok' : 'Not Ok',

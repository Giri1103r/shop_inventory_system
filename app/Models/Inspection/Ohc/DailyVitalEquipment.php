...
class DailyVitalEquipment extends Model
{
    ...
    public function list()
    {
        $request = request();
        $search = '';
        $query = $this->select('inspection_ohc_daily_vital_equipment_checklist.*', 'inspection_shift_option.*', 'masters_unit.*', 'inspection_ohc_daily_vital_equipment_checklist.created_by as checked_by' , 'inspection_ohc_daily_vital_equipment_checklist.created_at as inspected_created_at','inspection_ohc_daily_vital_equipment_checklist.date_of_inspection as inspection_date_of_inspection','inspection_ohc_daily_vital_equipment_checklist.id as inspection_id')

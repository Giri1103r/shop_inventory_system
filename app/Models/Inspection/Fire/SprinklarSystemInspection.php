...
class SprinklarSystemInspection extends Model
{
    ...
    public function list()
    {
        ...
        if (isset($request->order) && count($request->order) > 0) {
            ...
            switch ($columnName) {
                case "revision_data":
                    $query->orderBy('inspection_fire_sprinklar_system.revision_data', $columnorder);
                    break;
                case "issue_date":
                    $query = $query->orderBy('inspection_fire_sprinklar_system.issue_date', $columnorder);
                    break;
                case "document_number":
                    $query = $query->orderBy('inspection_fire_sprinklar_system.document_number', $columnorder);
                    break;
